...
struct sCO_OD_ROM CO_OD_ROM = {
	...
	/*1006*/ 0x0000L,
	/*1007*/ 0x0000L,
	/*1008*/ { 'Z', 'e', 'p', 'h', 'y', 'r', ' ', 'R', 'T', 'O', 'S', '/',
		   'C', 'A', 'N', 'o', 'p', 'e', 'n', 'N', 'o', 'd', 'e' },
	/*1009*/ { '3', '.', '0', '0' },
	/*100a*/ { '3', '.', '0', '0' },
	/*1012*/ 0x0000L,
	/*1014*/ 0x0080L,
	...
	/*1600*/
	{ { 0x0L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L,
	    0x0000L },
	  /*1601*/
	  { 0x0L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L,
	    0x0000L },
	  ...
	  { 0x0L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L,
	    0x0000L } },
	/*1800*/
	{ { 0x6L, 0x0180L, 0xfeL, 0x00, 0x0L, 0x00, 0x0L },
...
/*0x1200*/ const CO_OD_entryRecord_t OD_record1200[3] = {
	...
	{ (void *)&CO_OD_ROM.SDOServerParameter[0].COB_IDClientToServer, 0x85,
	  0x4 },
	{ (void *)&CO_OD_ROM.SDOServerParameter[0].COB_IDServerToClient, 0x85,
	  0x4 },
};

/*0x1400*/ const CO_OD_entryRecord_t OD_record1400[3] = {
	{ (void *)&CO_OD_ROM.RPDOCommunicationParameter[0].maxSubIndex, 0x05,
	  0x1 },
	{ (void *)&CO_OD_ROM.RPDOCommunicationParameter[0].COB_IDUsedByRPDO,
	  0x8d, 0x4 },
	{ (void *)&CO_OD_ROM.RPDOCommunicationParameter[0].transmissionType,
	  0x0d, 0x1 },
};

/*0x1401*/ const CO_OD_entryRecord_t OD_record1401[3] = {
	{ (void *)&CO_OD_ROM.RPDOCommunicationParameter[1].maxSubIndex, 0x05,
	  0x1 },
	{ (void *)&CO_OD_ROM.RPDOCommunicationParameter[1].COB_IDUsedByRPDO,
	  0x8d, 0x4 },
	{ (void *)&CO_OD_ROM.RPDOCommunicationParameter[1].transmissionType,
	  0x0d, 0x1 },
};

/*0x1402*/ const CO_OD_entryRecord_t OD_record1402[3] = {
	{ (void *)&CO_OD_ROM.RPDOCommunicationParameter[2].maxSubIndex, 0x05,
	  0x1 },
	{ (void *)&CO_OD_ROM.RPDOCommunicationParameter[2].COB_IDUsedByRPDO,
	  0x8d, 0x4 },
	{ (void *)&CO_OD_ROM.RPDOCommunicationParameter[2].transmissionType,
	  0x0d, 0x1 },
};

/*0x1403*/ const CO_OD_entryRecord_t OD_record1403[3] = {
	{ (void *)&CO_OD_ROM.RPDOCommunicationParameter[3].maxSubIndex, 0x05,
	  0x1 },
	{ (void *)&CO_OD_ROM.RPDOCommunicationParameter[3].COB_IDUsedByRPDO,
	  0x8d, 0x4 },
	{ (void *)&CO_OD_ROM.RPDOCommunicationParameter[3].transmissionType,
	  0x0d, 0x1 },
};

/*0x1600*/ const CO_OD_entryRecord_t OD_record1600[9] = {
	{ (void *)&CO_OD_ROM.RPDOMappingParameter[0].numberOfMappedObjects,
	  0x0d, 0x1 },
...
/*0x1602*/ const CO_OD_entryRecord_t OD_record1602[9] = {
	{ (void *)&CO_OD_ROM.RPDOMappingParameter[2].numberOfMappedObjects,
	  0x0d, 0x1 },
...
/*0x1603*/ const CO_OD_entryRecord_t OD_record1603[9] = {
	{ (void *)&CO_OD_ROM.RPDOMappingParameter[3].numberOfMappedObjects,
	  0x0d, 0x1 },
...
/*0x1800*/ const CO_OD_entryRecord_t OD_record1800[7] = {
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[0].maxSubIndex, 0x05,
	  0x1 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[0].COB_IDUsedByTPDO,
	  0x8d, 0x4 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[0].transmissionType,
	  0x0d, 0x1 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[0].inhibitTime, 0x8d,
	  0x2 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[0].compatibilityEntry,
	  0x05, 0x1 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[0].eventTimer, 0x8d,
	  0x2 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[0].SYNCStartValue, 0x0d,
	  0x1 },
};

/*0x1801*/ const CO_OD_entryRecord_t OD_record1801[7] = {
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[1].maxSubIndex, 0x05,
	  0x1 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[1].COB_IDUsedByTPDO,
	  0x8d, 0x4 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[1].transmissionType,
	  0x0d, 0x1 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[1].inhibitTime, 0x8d,
	  0x2 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[1].compatibilityEntry,
	  0x05, 0x1 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[1].eventTimer, 0x8d,
	  0x2 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[1].SYNCStartValue, 0x0d,
	  0x1 },
};

/*0x1802*/ const CO_OD_entryRecord_t OD_record1802[7] = {
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[2].maxSubIndex, 0x05,
	  0x1 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[2].COB_IDUsedByTPDO,
	  0x8d, 0x4 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[2].transmissionType,
	  0x0d, 0x1 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[2].inhibitTime, 0x8d,
	  0x2 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[2].compatibilityEntry,
	  0x05, 0x1 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[2].eventTimer, 0x8d,
	  0x2 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[2].SYNCStartValue, 0x0d,
	  0x1 },
};

/*0x1803*/ const CO_OD_entryRecord_t OD_record1803[7] = {
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[3].maxSubIndex, 0x05,
	  0x1 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[3].COB_IDUsedByTPDO,
	  0x8d, 0x4 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[3].transmissionType,
	  0x0d, 0x1 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[3].inhibitTime, 0x8d,
	  0x2 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[3].compatibilityEntry,
	  0x05, 0x1 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[3].eventTimer, 0x8d,
	  0x2 },
	{ (void *)&CO_OD_ROM.TPDOCommunicationParameter[3].SYNCStartValue, 0x0d,
	  0x1 },
};

/*0x1a00*/ const CO_OD_entryRecord_t OD_record1a00[9] = {
	{ (void *)&CO_OD_ROM.TPDOMappingParameter[0].numberOfMappedObjects,
	  0x0d, 0x1 },
...
/*0x1a01*/ const CO_OD_entryRecord_t OD_record1a01[9] = {
	{ (void *)&CO_OD_ROM.TPDOMappingParameter[1].numberOfMappedObjects,
	  0x0d, 0x1 },
...
/*0x1a02*/ const CO_OD_entryRecord_t OD_record1a02[9] = {
	{ (void *)&CO_OD_ROM.TPDOMappingParameter[2].numberOfMappedObjects,
	  0x0d, 0x1 },
...
/*0x1a03*/ const CO_OD_entryRecord_t OD_record1a03[9] = {
	{ (void *)&CO_OD_ROM.TPDOMappingParameter[3].numberOfMappedObjects,
	  0x0d, 0x1 },
...
const CO_OD_entry_t CO_OD[45] = {
	...
	{ 0x1002, 0x00, 0xa6, 4,
	  (void *)&CO_OD_RAM.manufacturerStatusRegister },
	...
	{ 0x1009, 0x00, 0x05, 4,
	  (void *)&CO_OD_ROM.manufacturerHardwareVersion },
	{ 0x100a, 0x00, 0x05, 4,
	  (void *)&CO_OD_ROM.manufacturerSoftwareVersion },
	{ 0x1010, 0x01, 0x8e, 4, (void *)&CO_OD_RAM.storeParameters[0] },
	{ 0x1011, 0x01, 0x8e, 4,
	  (void *)&CO_OD_RAM.restoreDefaultParameters[0] },
	...
	{ 0x1019, 0x00, 0x0d, 1,
	  (void *)&CO_OD_ROM.synchronousCounterOverflowValue },
	...
	{ 0x1f56, 0x01, 0x86, 4,
	  (void *)&CO_OD_RAM.programSoftwareIdentification[0] },
	{ 0x1f57, 0x01, 0x86, 4,
	  (void *)&CO_OD_RAM.flashStatusIdentification[0] },
