...
*******************************************************************************/
#define CO_OD_FIRST_LAST_WORD \
	0x55 /* Any value from 0x01 to 0xFE. If changed, EEPROM will be reinitialized. */
...
struct sCO_OD_ROM {
	...
	/*1400      */ OD_RPDOCommunicationParameter_t
		RPDOCommunicationParameter[4];
	/*1600      */ OD_RPDOMappingParameter_t RPDOMappingParameter[4];
	/*1800      */ OD_TPDOCommunicationParameter_t
		TPDOCommunicationParameter[4];
...
#define OD_synchronousCounterOverflowValue \
	CO_OD_ROM.synchronousCounterOverflowValue
