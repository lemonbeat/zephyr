...
static int psa_shell_invalid_arg(const struct shell *shell, char *arg_name)
{
...
static int psa_shell_cmd_version(const struct shell *shell, size_t argc,
				 char **argv)
{
...
SHELL_STATIC_SUBCMD_SET_CREATE(sub_psa,
			       ...
			       SHELL_CMD(version, NULL, "app version",
					 psa_shell_cmd_version),
			       /* Array terminator. */
