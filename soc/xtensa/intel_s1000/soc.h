...
#define DW_ICTL_IRQ_CAVS_OFFSET \
	CAVS_IRQ_NUMBER(DT_IRQN(DT_INST(0, snps_designware_intc)))
...
#define DSP_WCT_IRQ(x) SOC_AGGREGATE_IRQ(0, (23 + x), CAVS_L2_AGG_INT_LEVEL2)
...
#define SOC_LPGPDMAC_OWNER_DSP (BIT(15) | BIT_MASK(SOC_NUM_CHANNELS_IN_DMAC))

#define SOC_NUM_I2S_INSTANCES 4
/* bit field definition for IO peripheral ownership register */
#define SOC_DSPIOP_I2S_OWNSEL_DSP (BIT_MASK(SOC_NUM_I2S_INSTANCES) << 8)
...
#define SOC_L2RAM_LOCAL_MEM_REG_LSPGCTL (SOC_L2RAM_LOCAL_MEM_REG_BASE + 0x50)
