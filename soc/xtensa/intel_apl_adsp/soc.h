...
#define DW_DMA1_BASE_ADDR (0x0000C000 + 1 * LP_GP_DMA_SIZE)
#define DW_DMA2_BASE_ADDR (0x0000C000 + 2 * LP_GP_DMA_SIZE)
...
#define DSP_WCT_IRQ(x) SOC_AGGREGATE_IRQ((22 + x), CAVS_L2_AGG_INT_LEVEL2)
