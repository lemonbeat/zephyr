...
#define XCHAL_VECBASE_RESET_PADDR_SRAM (SRAM_BASE + HP_RAM_RESERVE_HEADER_SPACE)
...
#define XCHAL_KERNEL_VECTOR_PADDR_SRAM (XCHAL_VECBASE_RESET_PADDR_SRAM + 0x300)

#define XCHAL_USER_VECTOR_PADDR_SRAM (XCHAL_VECBASE_RESET_PADDR_SRAM + 0x340)
 ...
 */
#define RAM_BASE (SRAM_BASE + HP_RAM_RESERVE_HEADER_SPACE + VECTOR_TBL_SIZE)

#define RAM_SIZE (SRAM_SIZE - HP_RAM_RESERVE_HEADER_SPACE - VECTOR_TBL_SIZE)
