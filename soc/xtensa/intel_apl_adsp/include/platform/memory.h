...
#define HPSRAM_MASK(seg_idx)                                                   \
	((1 << (PLATFORM_HPSRAM_EBB_COUNT - EBB_BANKS_IN_SEGMENT * seg_idx)) - \
	 1)
...
#define HEAP_HP_BUFFER_COUNT (HEAP_HP_BUFFER_SIZE / HEAP_HP_BUFFER_BLOCK_SIZE)
