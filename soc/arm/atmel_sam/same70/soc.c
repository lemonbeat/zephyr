 ...
 */
#define PMC_CKGR_PLLAR_MULA (CKGR_PLLAR_MULA(CONFIG_SOC_ATMEL_SAME70_PLLA_MULA))
#define PMC_CKGR_PLLAR_DIVA (CKGR_PLLAR_DIVA(CONFIG_SOC_ATMEL_SAME70_PLLA_DIVA))
...
static ALWAYS_INLINE void clock_init(void)
{
	...
	if (!(PMC->CKGR_MOR & CKGR_MOR_MOSCSEL_Msk)) {
		...
		PMC->CKGR_MOR = CKGR_MOR_KEY_PASSWD | CKGR_MOR_MOSCSEL |
				CKGR_MOR_MOSCXTST(0xFFu) | CKGR_MOR_MOSCRCEN |
				CKGR_MOR_MOSCXTEN;
