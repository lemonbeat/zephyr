...
#define NPCX_WKEDG(base, n) (*(volatile uint8_t *)(base + NPCX_WKEDG_OFFSET(n)))
#define NPCX_WKAEDG(base, n) \
	(*(volatile uint8_t *)(base + NPCX_WKAEDG_OFFSET(n)))
#define NPCX_WKPND(base, n) (*(volatile uint8_t *)(base + NPCX_WKPND_OFFSET(n)))
#define NPCX_WKPCL(base, n) (*(volatile uint8_t *)(base + NPCX_WKPCL_OFFSET(n)))
#define NPCX_WKEN(base, n) (*(volatile uint8_t *)(base + NPCX_WKEN_OFFSET(n)))
#define NPCX_WKINEN(base, n) \
	(*(volatile uint8_t *)(base + NPCX_WKINEN_OFFSET(n)))
#define NPCX_WKMOD(base, n) (*(volatile uint8_t *)(base + NPCX_WKMOD_OFFSET(n)))
