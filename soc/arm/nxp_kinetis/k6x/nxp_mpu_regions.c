...
static const struct nxp_mpu_region mpu_regions[] = {
	 ...
	 */
	MPU_REGION_ENTRY("DEBUGGER_0", 0, 0xFFFFFFFF,
	...
	/* Region 1 */
	MPU_REGION_ENTRY("BACKGROUND_0", 0, CONFIG_SRAM_BASE_ADDRESS - 1,
			 REGION_BACKGROUND_ATTR),
	/* Region 2 */
	MPU_REGION_ENTRY("BACKGROUND_1",
			 CONFIG_SRAM_BASE_ADDRESS + (CONFIG_SRAM_SIZE * 1024),
			 0xFFFFFFFF, REGION_BACKGROUND_ATTR),
	/* Region 3 */
	MPU_REGION_ENTRY("FLASH_0", CONFIG_FLASH_BASE_ADDRESS, 0x07FFFFFF,
			 REGION_FLASH_ATTR),
	/* Region 4 */
	MPU_REGION_ENTRY(
		"RAM_U_0", CONFIG_SRAM_BASE_ADDRESS,
		(CONFIG_SRAM_BASE_ADDRESS + (CONFIG_SRAM_SIZE * 1024) - 1),
		REGION_RAM_ATTR),
};
