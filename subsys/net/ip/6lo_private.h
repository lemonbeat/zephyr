...
#define NET_6LO_IPHC_SA_MASK (NET_6LO_IPHC_SAC_MASK | NET_6LO_IPHC_SAM_MASK)
...
#define NET_6LO_IPHC_DA_MASK \
	(NET_6LO_IPHC_DAC_MASK | NET_6LO_IPHC_DAM_MASK | NET_6LO_IPHC_M_MASK)
