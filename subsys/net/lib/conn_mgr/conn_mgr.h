...
#define CONN_MGR_IFACE_MAX \
	MAX(CONFIG_NET_IF_MAX_IPV6_COUNT, CONFIG_NET_IF_MAX_IPV4_COUNT)
...
#define CONN_MGR_IFACE_EVENTS_MASK (NET_EVENT_IF_DOWN | NET_EVENT_IF_UP)

#define CONN_MGR_IPV6_EVENTS_MASK                            \
	(NET_EVENT_IPV6_ADDR_ADD | NET_EVENT_IPV6_ADDR_DEL | \
	 NET_EVENT_IPV6_DAD_SUCCEED | NET_EVENT_IPV6_DAD_FAILED)

#define CONN_MGR_IPV4_EVENTS_MASK \
	(NET_EVENT_IPV4_ADDR_ADD | NET_EVENT_IPV4_ADDR_DEL)

#define CONN_MGR_IPV6_STATUS_MASK \
	(NET_STATE_IPV6_ADDR_SET | NET_STATE_IPV6_DAD_OK)
