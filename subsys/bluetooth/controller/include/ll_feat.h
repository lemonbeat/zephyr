...
#define LL_FEAT_BIT_MIN_USED_CHAN BIT64(BT_LE_FEAT_BIT_MIN_USED_CHAN_PROC)
...
#define LL_FEAT_BIT_SMI_TX \
	(ll_settings_smi_tx() ? BIT64(BT_LE_FEAT_BIT_SMI_TX) : 0)
...
#define LL_FEAT                                                             \
	(LL_FEAT_BIT_ENC | LL_FEAT_BIT_CONN_PARAM_REQ |                     \
	 LL_FEAT_BIT_EXT_REJ_IND | LL_FEAT_BIT_SLAVE_FEAT_REQ |             \
	 LL_FEAT_BIT_PING | LL_FEAT_BIT_DLE | LL_FEAT_BIT_PRIVACY |         \
	 LL_FEAT_BIT_EXT_SCAN | LL_FEAT_BIT_PHY_2M | LL_FEAT_BIT_SMI_TX |   \
	 LL_FEAT_BIT_SMI_RX | LL_FEAT_BIT_PHY_CODED | LL_FEAT_BIT_EXT_ADV | \
	 LL_FEAT_BIT_CHAN_SEL_2 | LL_FEAT_BIT_MIN_USED_CHAN)
