...
void test_crc16(void)
{
	...
	zassert_equal(crc16(test0, sizeof(test0), 0x1021, 0xffff, true), 0x1d0f,
		      NULL);
	zassert_equal(crc16(test1, sizeof(test1), 0x1021, 0xffff, true), 0x9479,
		      NULL);
	zassert_equal(crc16(test2, sizeof(test2), 0x1021, 0xffff, true), 0xe5cc,
		      NULL);
}
...
void test_crc16_ccitt_for_ppp(void)
{
	 ...
	 */
	uint8_t test0[] = { 0xff, 0x03, 0xc0, 0x21, 0x01, 0x01, 0x00, 0x17,
			    0x02, 0x06, 0x00, 0x0a, 0x00, 0x00, 0x05, 0x06,
			    0x00, 0x2a, 0x2b, 0x78, 0x07, 0x02, 0x08, 0x02,
			    0x0d, 0x03, 0x06, 0xa5, 0xf8 };
	uint8_t test2[] = { '1', '2', '3', '4', '5', '6', '7', '8', '9' };

	zassert_equal(crc16_ccitt(0xffff, test0, sizeof(test0)), 0xf0b8, NULL);
...
void test_crc8_ccitt(void)
{
	...
	zassert(crc8_ccitt(CRC8_CCITT_INITIAL_VALUE, test0, sizeof(test0)) ==
			0xF3,
		"pass", "fail");
	zassert(crc8_ccitt(CRC8_CCITT_INITIAL_VALUE, test1, sizeof(test1)) ==
			0x33,
		"pass", "fail");
	zassert(crc8_ccitt(CRC8_CCITT_INITIAL_VALUE, test2, sizeof(test2)) ==
			0xFB,
		"pass", "fail");
}
...
void test_main(void)
{
	ztest_test_suite(test_crc, ztest_unit_test(test_crc32_ieee),
