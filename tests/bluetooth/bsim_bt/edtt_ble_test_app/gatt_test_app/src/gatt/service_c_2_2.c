...
static struct bt_gatt_attr service_c_2_2_attrs[] = {
	...
	BT_GATT_H_CHARACTERISTIC(
		...
		write_value_v2, &value_v2_value, 0x13),
	BT_GATT_H_CHARACTERISTIC(
		BT_UUID_VALUE_V2, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE,
		BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_str_value,
		write_value_v2_1, &value_v2_1_value, 0x15),
	BT_GATT_H_CHARACTERISTIC(
		BT_UUID_VALUE_V2, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE,
		BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_str_value,
		write_value_v2_2, &value_v2_2_value, 0x17),
	BT_GATT_H_CHARACTERISTIC(
		BT_UUID_VALUE_V2, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE,
		BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_str_value,
		write_value_v2_3, &value_v2_3_value, 0x19),
	BT_GATT_H_CHARACTERISTIC(
		BT_UUID_VALUE_V2, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE,
		BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_str_value,
		write_value_v2_4, &value_v2_4_value, 0x1B),
	BT_GATT_H_CHARACTERISTIC(
		BT_UUID_VALUE_V2, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE,
		BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_str_value,
		write_value_v2_5, &value_v2_5_value, 0x1D)
};
