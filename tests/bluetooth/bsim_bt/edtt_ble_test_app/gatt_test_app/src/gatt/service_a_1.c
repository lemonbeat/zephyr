...
static struct bt_gatt_attr service_a_1_attrs[] = {
	...
	BT_GATT_H_CHARACTERISTIC(BT_UUID_VALUE_V1, BT_GATT_CHRC_READ,
				 BT_GATT_PERM_READ_ENCRYPT, read_value_v1, NULL,
				 &value_v1_value, 0x22),
	BT_GATT_H_CHARACTERISTIC(
		...
		write_value_v2, &value_v2_value, 0x24),
	BT_GATT_H_CHARACTERISTIC(BT_UUID_VALUE_V2, BT_GATT_CHRC_WRITE,
				 BT_GATT_PERM_WRITE, NULL, write_value_v2_1,
				 &value_v2_1_value, 0x26),
