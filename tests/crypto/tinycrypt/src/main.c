...
{
	ztest_test_suite(
		test_tinycrypt, ztest_unit_test(test_aes_key_chain),
		...
		ztest_unit_test(test_sha256_1), ztest_unit_test(test_sha256_2),
		ztest_unit_test(test_sha256_3), ztest_unit_test(test_sha256_4),
		ztest_unit_test(test_sha256_5), ztest_unit_test(test_sha256_6),
		ztest_unit_test(test_sha256_7), ztest_unit_test(test_sha256_8),
		ztest_unit_test(test_sha256_9), ztest_unit_test(test_sha256_10),
		ztest_unit_test(test_sha256_11),
		ztest_unit_test(test_sha256_12),
		ztest_unit_test(test_sha256_13_and_14),
		ztest_unit_test(test_hmac_1), ztest_unit_test(test_hmac_2),
		ztest_unit_test(test_hmac_3), ztest_unit_test(test_hmac_4),
		ztest_unit_test(test_hmac_5), ztest_unit_test(test_hmac_6),
		...
		ztest_unit_test(test_ecc_dh), ztest_unit_test(test_ecc_dsa),
