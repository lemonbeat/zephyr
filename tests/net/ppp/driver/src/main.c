...
static uint8_t ppp_recv_data1[] = {
	0x7e, 0xff, 0x7d, 0x23, 0xc0, 0x21, 0x7d, 0x21, 0x7d, 0x21, 0x7d, 0x20,
	0x7d, 0x34, 0x7d, 0x22, 0x7d, 0x26, 0x7d, 0x20, 0x7d, 0x20, 0x7d, 0x20,
	0x7d, 0x20, 0x7d, 0x25, 0x7d, 0x26, 0x5d, 0x58, 0xcf, 0x41, 0x7d, 0x27,
	0x7d, 0x22, 0x7d, 0x28, 0x7d, 0x22, 0xc4, 0xc9, 0x7e,
};

/* then we should see this FCS checked PPP data */
static uint8_t ppp_expect_data1[] = {
	0xc0, 0x21, 0x01, 0x01, 0x00, 0x14, 0x02, 0x06, 0x00, 0x00, 0x00,
	0x00, 0x05, 0x06, 0x5d, 0x58, 0xcf, 0x41, 0x07, 0x02, 0x08, 0x02,
};
...
static uint8_t ppp_recv_data3[] = { 0x7e, 0xff, 0x7d, 0x23, 0xc0, 0x21,
				    0x7d, 0x22, 0x7d, 0x21, 0x7d, 0x20,
				    0x7d, 0x24, 0x1c, 0x90, 0x7e };
...
static uint8_t ppp_recv_data4[] = {
	...
	0x7e, 0xff, 0x7d, 0x5d, 0xe4, 0x7d, 0x23, 0xc0, 0x21, 0x7d, 0x22,
	0x7d, 0x21, 0x7d, 0x20, 0x7d, 0x24, 0x7d, 0x3c, 0x90, 0x7e,
};

static uint8_t ppp_expect_data4[] = {
	0xff, 0x7d, 0xe4, 0x03, 0xc0, 0x21, 0x02, 0x01, 0x00, 0x04, 0x1c, 0x90,
};
...
static uint8_t ppp_expect_data5[] = {
	0xc0, 0x21, 0x01, 0x03, 0x00, 0x14, 0x02, 0x06, 0x00, 0x00, 0x00,
	0x00, 0x05, 0x06, 0x66, 0x06, 0xbe, 0x70, 0x07, 0x02, 0x08, 0x02,
};

static uint8_t ppp_recv_data6[] = {
	0x7e, 0xff, 0x7d, 0x23, 0xc0, 0x21, 0x7d, 0x22, 0x7d,
	0x21, 0x7d, 0x20, 0x7d, 0x24, 0x7d, 0x3c, 0x90, 0x7e,
};
...
static uint8_t ppp_recv_data7[] = {
	0x7e, 0xff, 0x7d, 0x23, 0x80, 0x21, 0x7d, 0x22, 0x7d, 0x22,
	0x7d, 0x20, 0x7d, 0x2a, 0x7d, 0x23, 0x7d, 0x26, 0xc0, 0x7d,
	0x20, 0x7d, 0x22, 0x7d, 0x22, 0x06, 0xa1, 0x7e,
};

static uint8_t ppp_expect_data7[] = {
	0x80, 0x21, 0x02, 0x02, 0x00, 0x0a, 0x03, 0x06, 0xc0, 0x00, 0x02, 0x02,
};

static uint8_t ppp_recv_data8[] = {
	0x7e, 0xff, 0x7d, 0x23, 0x00, 0x57, 0x60, 0x7d, 0x20, 0x7d, 0x20,
	0x7d, 0x20, 0x7d, 0x20, 0x7d, 0x2c, 0x3a, 0x40, 0xfe, 0x80, 0x7d,
	0x20, 0x7d, 0x20, 0x7d, 0x20, 0x7d, 0x20, 0x7d, 0x20, 0x7d, 0x20,
	0x7d, 0x20, 0x7d, 0x20, 0x5e, 0xff, 0xfe, 0x7d, 0x20, 0x53, 0x44,
	0xfe, 0x80, 0x7d, 0x20, 0x7d, 0x20, 0x7d, 0x20, 0x7d, 0x20, 0x7d,
	0x20, 0x7d, 0x20, 0xa1, 0x41, 0x6d, 0x45, 0xbf, 0x28, 0x7d, 0x25,
	0xd1, 0x80, 0x7d, 0x20, 0x7d, 0x28, 0x6c, 0x7d, 0x5e, 0x32, 0x7d,
	0x20, 0x7d, 0x22, 0x5b, 0x2c, 0x7d, 0x3d, 0x25, 0x20, 0x11, 0x7e,
};

static uint8_t ppp_expect_data8[] = {
	0x60, 0x00, 0x00, 0x00, 0x00, 0x0c, 0x3a, 0x40, 0xfe, 0x80, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5e, 0xff, 0xfe, 0x00,
	0x53, 0x44, 0xfe, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xa1,
	0x41, 0x6d, 0x45, 0xbf, 0x28, 0x05, 0xd1, 0x80, 0x00, 0x08, 0x6c,
	0x7e, 0x32, 0x00, 0x02, 0x5b, 0x2c, 0x1d, 0x25,
};
	...
	if (test_started) {
		...
		while (buf) {
			if (memcmp(expecting + pos, buf->data, buf->len)) {
				LOG_HEXDUMP_DBG(expecting + pos, buf->len,
						"expecting");
...
static bool send_iface(struct net_if *iface, uint8_t *recv, size_t recv_len,
...
static void ppp_verify_fcs(uint8_t *buf, int len)
{
	...
	zassert_true(ret, "FCS calc failed, expecting 0x%x got 0x%x", 0xf0b8,
		     fcs);
...
{
	ztest_test_suite(
		net_ppp_test, ztest_unit_test(test_iface_setup),
