...
int debug_cb(struct usb_setup_packet *setup, int32_t *len, uint8_t **data)
{
...
int set_idle_cb(struct usb_setup_packet *setup, int32_t *len, uint8_t **data)
{
...
int get_report_cb(struct usb_setup_packet *setup, int32_t *len, uint8_t **data)
{
