...
static void test_arm_add_f32(const uint32_t *input1, const uint32_t *input2,
...
static void test_arm_sub_f32(const uint32_t *input1, const uint32_t *input2,
			     const uint32_t *ref, size_t length)
{
	float32_t *output;
...
static void test_arm_mult_f32(const uint32_t *input1, const uint32_t *input2,
			      const uint32_t *ref, size_t length)
{
	float32_t *output;
...
static void test_arm_negate_f32(const uint32_t *input1, const uint32_t *ref,
				size_t length)
{
	float32_t *output;
...
static void test_arm_offset_f32(const uint32_t *input1, float32_t scalar,
				const uint32_t *ref, size_t length)
{
	float32_t *output;
...
static void test_arm_scale_f32(const uint32_t *input1, float32_t scalar,
			       const uint32_t *ref, size_t length)
{
	float32_t *output;
...
static void test_arm_dot_prod_f32(const uint32_t *input1,
				  const uint32_t *input2, const uint32_t *ref,
				  size_t length)
{
	float32_t *output;
	...
	/* Run test function */
	arm_dot_prod_f32((float32_t *)input1, (float32_t *)input2, length,
			 &output[0]);

	/* Validate output */
	zassert_true(test_snr_error_f32(1, output, (float32_t *)ref,
					SNR_ERROR_THRESH),
		     ASSERT_MSG_SNR_LIMIT_EXCEED);

	zassert_true(test_rel_error_f32(1, output, (float32_t *)ref,
					REL_ERROR_THRESH),
		     ASSERT_MSG_REL_ERROR_LIMIT_EXCEED);
...
DEFINE_TEST_VARIANT4(arm_dot_prod_f32, 11, in_com1, in_com2, ref_dot_prod_4n1,
		     11);

static void test_arm_abs_f32(const uint32_t *input1, const uint32_t *ref,
			     size_t length)
{
	float32_t *output;
...
{
	ztest_test_suite(basicmath_f32, ztest_unit_test(test_arm_add_f32_3),
