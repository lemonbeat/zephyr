...
static void test_arm_add_q31(const q31_t *input1, const q31_t *input2,
...
DEFINE_TEST_VARIANT4(arm_add_q31, possat, in_maxpos, in_maxpos, ref_add_possat,
		     9);
DEFINE_TEST_VARIANT4(arm_add_q31, negsat, in_maxneg, in_maxneg, ref_add_negsat,
		     9);

static void test_arm_sub_q31(const q31_t *input1, const q31_t *input2,
			     const q31_t *ref, size_t length)
{
	q31_t *output;
...
DEFINE_TEST_VARIANT4(arm_sub_q31, possat, in_maxpos, in_maxneg, ref_sub_possat,
		     9);
DEFINE_TEST_VARIANT4(arm_sub_q31, negsat, in_maxneg, in_maxpos, ref_sub_negsat,
		     9);

static void test_arm_mult_q31(const q31_t *input1, const q31_t *input2,
			      const q31_t *ref, size_t length)
{
	q31_t *output;
...
DEFINE_TEST_VARIANT4(arm_mult_q31, possat, in_maxneg2, in_maxneg2,
		     ref_mult_possat, 9);

static void test_arm_negate_q31(const q31_t *input1, const q31_t *ref,
				size_t length)
{
	q31_t *output;
...
static void test_arm_offset_q31(const q31_t *input1, q31_t scalar,
				const q31_t *ref, size_t length)
{
	q31_t *output;
...
DEFINE_TEST_VARIANT4(arm_offset_q31, 0p5_11, in_com1, 0x40000000, ref_offset,
		     11);
DEFINE_TEST_VARIANT4(arm_offset_q31, possat, in_maxpos, 0x73333333,
		     ref_offset_possat, 9);
DEFINE_TEST_VARIANT4(arm_offset_q31, negsat, in_maxneg, 0x8ccccccd,
		     ref_offset_negsat, 9);

static void test_arm_scale_q31(const q31_t *input1, q31_t scalar,
			       const q31_t *ref, size_t length)
{
	q31_t *output;
...
DEFINE_TEST_VARIANT4(arm_scale_q31, possat, in_maxneg2, 0x80000000,
		     ref_scale_possat, 9);

static void test_arm_dot_prod_q31(const q31_t *input1, const q31_t *input2,
...
DEFINE_TEST_VARIANT4(arm_dot_prod_q31, 11, in_com1, in_com2, ref_dot_prod_4n1,
		     11);

static void test_arm_abs_q31(const q31_t *input1, const q31_t *ref,
			     size_t length)
{
	q31_t *output;
...
static void test_arm_shift_q31(const q31_t *input1, const q31_t *ref,
			       size_t length)
{
	q31_t *output;
...
static void test_arm_and_u32(const uint32_t *input1, const uint32_t *input2,
			     const uint32_t *ref, size_t length)
{
	...
	/* Validate output */
	zassert_true(test_equal_q31(length, output, ref),
...
static void test_arm_or_u32(const uint32_t *input1, const uint32_t *input2,
			    const uint32_t *ref, size_t length)
{
	uint32_t *output;
...
static void test_arm_not_u32(const uint32_t *input1, const uint32_t *ref,
			     size_t length)
{
	uint32_t *output;
...
static void test_arm_xor_u32(const uint32_t *input1, const uint32_t *input2,
			     const uint32_t *ref, size_t length)
{
	uint32_t *output;
...
{
	ztest_test_suite(basicmath_q31, ztest_unit_test(test_arm_add_q31_3),
