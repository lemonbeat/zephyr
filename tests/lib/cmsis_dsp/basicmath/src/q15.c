...
static void test_arm_add_q15(const q15_t *input1, const q15_t *input2,
...
DEFINE_TEST_VARIANT4(arm_add_q15, possat, in_maxpos, in_maxpos, ref_add_possat,
		     17);
DEFINE_TEST_VARIANT4(arm_add_q15, negsat, in_maxneg, in_maxneg, ref_add_negsat,
		     17);

static void test_arm_sub_q15(const q15_t *input1, const q15_t *input2,
			     const q15_t *ref, size_t length)
{
	q15_t *output;
...
DEFINE_TEST_VARIANT4(arm_sub_q15, possat, in_maxpos, in_maxneg, ref_sub_possat,
		     17);
DEFINE_TEST_VARIANT4(arm_sub_q15, negsat, in_maxneg, in_maxpos, ref_sub_negsat,
		     17);

static void test_arm_mult_q15(const q15_t *input1, const q15_t *input2,
			      const q15_t *ref, size_t length)
{
	q15_t *output;
...
DEFINE_TEST_VARIANT4(arm_mult_q15, possat, in_maxneg2, in_maxneg2,
		     ref_mult_possat, 17);

static void test_arm_negate_q15(const q15_t *input1, const q15_t *ref,
				size_t length)
{
	q15_t *output;
...
static void test_arm_offset_q15(const q15_t *input1, q15_t scalar,
				const q15_t *ref, size_t length)
{
	q15_t *output;
...
DEFINE_TEST_VARIANT4(arm_offset_q15, possat, in_maxpos, 0x7333,
		     ref_offset_possat, 17);
DEFINE_TEST_VARIANT4(arm_offset_q15, negsat, in_maxneg, 0x8ccd,
		     ref_offset_negsat, 17);

static void test_arm_scale_q15(const q15_t *input1, q15_t scalar,
			       const q15_t *ref, size_t length)
{
	q15_t *output;
...
DEFINE_TEST_VARIANT4(arm_scale_q15, possat, in_maxneg2, 0x8000,
		     ref_scale_possat, 17);

static void test_arm_dot_prod_q15(const q15_t *input1, const q15_t *input2,
				  const q63_t *ref, size_t length)
{
	...
	/* Validate output */
	zassert_true(test_snr_error_q63(1, output, ref, SNR_ERROR_THRESH_HIGH),
		     ASSERT_MSG_SNR_LIMIT_EXCEED);
...
DEFINE_TEST_VARIANT4(arm_dot_prod_q15, 16, in_com1, in_com2, ref_dot_prod_4,
		     16);
DEFINE_TEST_VARIANT4(arm_dot_prod_q15, 23, in_com1, in_com2, ref_dot_prod_4n1,
		     23);

static void test_arm_abs_q15(const q15_t *input1, const q15_t *ref,
			     size_t length)
{
	q15_t *output;
...
static void test_arm_shift_q15(const q15_t *input1, const q15_t *ref,
			       size_t length)
{
	q15_t *output;
...
static void test_arm_and_u16(const uint16_t *input1, const uint16_t *input2,
			     const uint16_t *ref, size_t length)
{
	...
	/* Validate output */
	zassert_true(test_equal_q15(length, output, ref),
...
static void test_arm_or_u16(const uint16_t *input1, const uint16_t *input2,
			    const uint16_t *ref, size_t length)
{
	uint16_t *output;
...
static void test_arm_not_u16(const uint16_t *input1, const uint16_t *ref,
			     size_t length)
{
	uint16_t *output;
...
static void test_arm_xor_u16(const uint16_t *input1, const uint16_t *input2,
			     const uint16_t *ref, size_t length)
{
	uint16_t *output;
...
{
	ztest_test_suite(basicmath_q15, ztest_unit_test(test_arm_add_q15_7),
