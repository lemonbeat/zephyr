...
static void test_arm_add_q7(const q7_t *input1, const q7_t *input2,
			    const q7_t *ref, size_t length)
{
	...
	zassert_true(test_near_equal_q7(length, output, ref,
					ABS_ERROR_THRESH_Q7),
...
DEFINE_TEST_VARIANT4(arm_add_q7, possat, in_maxpos, in_maxpos, ref_add_possat,
		     33);
DEFINE_TEST_VARIANT4(arm_add_q7, negsat, in_maxneg, in_maxneg, ref_add_negsat,
		     33);

static void test_arm_sub_q7(const q7_t *input1, const q7_t *input2,
			    const q7_t *ref, size_t length)
{
	q7_t *output;
...
DEFINE_TEST_VARIANT4(arm_sub_q7, possat, in_maxpos, in_maxneg, ref_sub_possat,
		     33);
DEFINE_TEST_VARIANT4(arm_sub_q7, negsat, in_maxneg, in_maxpos, ref_sub_negsat,
		     33);

static void test_arm_mult_q7(const q7_t *input1, const q7_t *input2,
			     const q7_t *ref, size_t length)
{
	q7_t *output;
...
DEFINE_TEST_VARIANT4(arm_mult_q7, possat, in_maxneg2, in_maxneg2,
		     ref_mult_possat, 33);

static void test_arm_negate_q7(const q7_t *input1, const q7_t *ref,
			       size_t length)
{
	q7_t *output;
...
static void test_arm_offset_q7(const q7_t *input1, q7_t scalar, const q7_t *ref,
			       size_t length)
{
	q7_t *output;
...
DEFINE_TEST_VARIANT4(arm_offset_q7, possat, in_maxpos, 0x73, ref_offset_possat,
		     33);
DEFINE_TEST_VARIANT4(arm_offset_q7, negsat, in_maxneg, 0x8d, ref_offset_negsat,
		     33);

static void test_arm_scale_q7(const q7_t *input1, q7_t scalar, const q7_t *ref,
			      size_t length)
{
	q7_t *output;
...
DEFINE_TEST_VARIANT4(arm_scale_q7, possat, in_maxneg2, 0x80, ref_scale_possat,
		     33);

static void test_arm_dot_prod_q7(const q7_t *input1, const q7_t *input2,
				 const q31_t *ref, size_t length)
{
	...
	/* Validate output */
	zassert_true(test_snr_error_q31(1, output, ref, SNR_ERROR_THRESH),
		     ASSERT_MSG_SNR_LIMIT_EXCEED);

	zassert_true(test_near_equal_q31(1, output, ref, ABS_ERROR_THRESH_Q31),
		     ASSERT_MSG_ABS_ERROR_LIMIT_EXCEED);
...
DEFINE_TEST_VARIANT4(arm_dot_prod_q7, 47, in_com1, in_com2, ref_dot_prod_4n1,
		     47);

static void test_arm_abs_q7(const q7_t *input1, const q7_t *ref, size_t length)
{
	q7_t *output;
...
static void test_arm_shift_q7(const q7_t *input1, const q7_t *ref,
			      size_t length)
{
	q7_t *output;
...
static void test_arm_and_u8(const uint8_t *input1, const uint8_t *input2,
			    const uint8_t *ref, size_t length)
{
	...
	/* Validate output */
	zassert_true(test_equal_q7(length, output, ref),
...
static void test_arm_or_u8(const uint8_t *input1, const uint8_t *input2,
			   const uint8_t *ref, size_t length)
{
	uint8_t *output;
...
static void test_arm_not_u8(const uint8_t *input1, const uint8_t *ref,
			    size_t length)
{
	uint8_t *output;
...
static void test_arm_xor_u8(const uint8_t *input1, const uint8_t *input2,
			    const uint8_t *ref, size_t length)
{
	uint8_t *output;
...
{
	ztest_test_suite(basicmath_q7, ztest_unit_test(test_arm_add_q7_15),
