...
DEFINE_TEST_VARIANT3(op2, arm_mat_add_q15, OP2_ADD, ref_add,
		     ARRAY_SIZE(ref_add));
DEFINE_TEST_VARIANT3(op2, arm_mat_sub_q15, OP2_SUB, ref_sub,
		     ARRAY_SIZE(ref_sub));
...
DEFINE_TEST_VARIANT4(op1, arm_mat_scale_q15, OP1_SCALE, ref_scale,
		     ARRAY_SIZE(ref_scale), false);
DEFINE_TEST_VARIANT4(op1, arm_mat_trans_q15, OP1_TRANS, ref_trans,
