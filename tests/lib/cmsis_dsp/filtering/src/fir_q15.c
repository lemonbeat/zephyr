...
static void test_arm_fir_q15(void)
{
	...
	/* Validate output */
	zassert_true(test_snr_error_q15(length, output_buf, ref,
					SNR_ERROR_THRESH),
		     ASSERT_MSG_SNR_LIMIT_EXCEED);

	zassert_true(test_near_equal_q15(length, output_buf, ref,
...
{
	ztest_test_suite(filtering_fir_q15, ztest_unit_test(test_arm_fir_q15));
