...
static void test_arm_correlate_q15(size_t in1_length, size_t in2_length,
				   const q15_t *ref, size_t ref_length)
{
	q15_t *output;
	...
	/* Validate output */
	zassert_true(test_snr_error_q15(ref_length, ref, output,
					SNR_ERROR_THRESH),
		     ASSERT_MSG_SNR_LIMIT_EXCEED);

	zassert_true(test_near_equal_q15(ref_length, ref, output,
...
#define DEFINE_CORRELATE_TEST(a, b)                            \
	DEFINE_TEST_VARIANT4(arm_correlate_q15, a##_##b, a, b, \
...
static void test_arm_conv_q15(size_t in1_length, size_t in2_length,
			      const q15_t *ref, size_t ref_length)
{
	q15_t *output;
...
#define DEFINE_CONV_TEST(a, b)                                                \
	DEFINE_TEST_VARIANT4(arm_conv_q15, a##_##b, a, b, ref_conv_##a##_##b, \
