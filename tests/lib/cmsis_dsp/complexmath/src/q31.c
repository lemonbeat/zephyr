...
static void test_arm_cmplx_conj_q31(const q31_t *input1, const q31_t *ref,
				    size_t length)
{
	size_t buf_length;
	q31_t *output;
	...
	/* Validate output */
	zassert_true(test_snr_error_q31(buf_length, output, ref,
					SNR_ERROR_THRESH),
		     ASSERT_MSG_SNR_LIMIT_EXCEED);

	zassert_true(test_near_equal_q31(buf_length, output, ref,
...
static void test_arm_cmplx_dot_prod_q31(const q31_t *input1,
					const q31_t *input2, const q63_t *ref,
					size_t length)
{
	q63_t *output;
	...
	/* Validate output */
	zassert_true(test_snr_error_q63(2, output, ref, SNR_ERROR_THRESH),
		     ASSERT_MSG_SNR_LIMIT_EXCEED);

	zassert_true(test_near_equal_q63(2, output, ref, ABS_ERROR_THRESH_Q63),
		     ASSERT_MSG_ABS_ERROR_LIMIT_EXCEED);
...
DEFINE_TEST_VARIANT4(arm_cmplx_dot_prod_q31, 3, in_com1, in_com2,
		     ref_dot_prod_3, 3);
DEFINE_TEST_VARIANT4(arm_cmplx_dot_prod_q31, 8, in_com1, in_com2,
		     ref_dot_prod_4n, 8);
DEFINE_TEST_VARIANT4(arm_cmplx_dot_prod_q31, 11, in_com1, in_com2,
		     ref_dot_prod_4n1, 11);

static void test_arm_cmplx_mag_q31(const q31_t *input1, const q31_t *ref,
				   size_t length)
{
	q31_t *output;
...
static void test_arm_cmplx_mag_squared_q31(const q31_t *input1,
...
DEFINE_TEST_VARIANT3(arm_cmplx_mag_squared_q31, 11, in_com1, ref_mag_squared,
		     11);

static void test_arm_cmplx_mult_cmplx_q31(const q31_t *input1,
					  const q31_t *input2, const q31_t *ref,
					  size_t length)
{
	size_t buf_length;
	q31_t *output;
...
DEFINE_TEST_VARIANT4(arm_cmplx_mult_cmplx_q31, 3, in_com1, in_com2,
		     ref_mult_cmplx, 3);
DEFINE_TEST_VARIANT4(arm_cmplx_mult_cmplx_q31, 8, in_com1, in_com2,
		     ref_mult_cmplx, 8);
DEFINE_TEST_VARIANT4(arm_cmplx_mult_cmplx_q31, 11, in_com1, in_com2,
		     ref_mult_cmplx, 11);

static void test_arm_cmplx_mult_real_q31(const q31_t *input1,
					 const q31_t *input2, const q31_t *ref,
					 size_t length)
{
	size_t buf_length;
...
DEFINE_TEST_VARIANT4(arm_cmplx_mult_real_q31, 3, in_com1, in_com3,
		     ref_mult_real, 3);
DEFINE_TEST_VARIANT4(arm_cmplx_mult_real_q31, 8, in_com1, in_com3,
		     ref_mult_real, 8);
DEFINE_TEST_VARIANT4(arm_cmplx_mult_real_q31, 11, in_com1, in_com3,
		     ref_mult_real, 11);
