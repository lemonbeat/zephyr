...
static void test_arm_cmplx_conj_q15(const q15_t *input1, const q15_t *ref,
				    size_t length)
{
	size_t buf_length;
	q15_t *output;
	...
	/* Validate output */
	zassert_true(test_snr_error_q15(buf_length, output, ref,
					SNR_ERROR_THRESH),
		     ASSERT_MSG_SNR_LIMIT_EXCEED);

	zassert_true(test_near_equal_q15(buf_length, output, ref,
...
static void test_arm_cmplx_dot_prod_q15(const q15_t *input1,
					const q15_t *input2, const q31_t *ref,
					size_t length)
{
	q31_t *output;
	...
	/* Validate output */
	zassert_true(test_snr_error_q31(2, output, ref, SNR_ERROR_THRESH),
		     ASSERT_MSG_SNR_LIMIT_EXCEED);

	zassert_true(test_near_equal_q31(2, output, ref, ABS_ERROR_THRESH_Q31),
		     ASSERT_MSG_ABS_ERROR_LIMIT_EXCEED);
...
DEFINE_TEST_VARIANT4(arm_cmplx_dot_prod_q15, 7, in_com1, in_com2,
		     ref_dot_prod_3, 7);
DEFINE_TEST_VARIANT4(arm_cmplx_dot_prod_q15, 16, in_com1, in_com2,
		     ref_dot_prod_4n, 16);
DEFINE_TEST_VARIANT4(arm_cmplx_dot_prod_q15, 23, in_com1, in_com2,
		     ref_dot_prod_4n1, 23);

static void test_arm_cmplx_mag_q15(const q15_t *input1, const q15_t *ref,
				   size_t length)
{
	q15_t *output;
...
static void test_arm_cmplx_mag_squared_q15(const q15_t *input1,
...
DEFINE_TEST_VARIANT3(arm_cmplx_mag_squared_q15, 16, in_com1, ref_mag_squared,
		     16);
DEFINE_TEST_VARIANT3(arm_cmplx_mag_squared_q15, 23, in_com1, ref_mag_squared,
		     23);

static void test_arm_cmplx_mult_cmplx_q15(const q15_t *input1,
					  const q15_t *input2, const q15_t *ref,
					  size_t length)
{
	size_t buf_length;
	q15_t *output;
...
DEFINE_TEST_VARIANT4(arm_cmplx_mult_cmplx_q15, 7, in_com1, in_com2,
		     ref_mult_cmplx, 7);
DEFINE_TEST_VARIANT4(arm_cmplx_mult_cmplx_q15, 16, in_com1, in_com2,
		     ref_mult_cmplx, 16);
DEFINE_TEST_VARIANT4(arm_cmplx_mult_cmplx_q15, 23, in_com1, in_com2,
		     ref_mult_cmplx, 23);

static void test_arm_cmplx_mult_real_q15(const q15_t *input1,
					 const q15_t *input2, const q15_t *ref,
					 size_t length)
{
	size_t buf_length;
...
DEFINE_TEST_VARIANT4(arm_cmplx_mult_real_q15, 7, in_com1, in_com3,
		     ref_mult_real, 7);
DEFINE_TEST_VARIANT4(arm_cmplx_mult_real_q15, 16, in_com1, in_com3,
		     ref_mult_real, 16);
DEFINE_TEST_VARIANT4(arm_cmplx_mult_real_q15, 23, in_com1, in_com3,
		     ref_mult_real, 23);
