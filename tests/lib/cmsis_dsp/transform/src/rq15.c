...
static void test_arm_rfft_q15(const q15_t *input, const q15_t *ref,
			      size_t length)
{
...
DEFINE_TEST_VARIANT3(arm_rfft_q15, noisy_32, in_rfft_noisy_32,
		     ref_rfft_noisy_32, 32);

DEFINE_TEST_VARIANT3(arm_rfft_q15, noisy_64, in_rfft_noisy_64,
		     ref_rfft_noisy_64, 64);

DEFINE_TEST_VARIANT3(arm_rfft_q15, noisy_128, in_rfft_noisy_128,
		     ref_rfft_noisy_128, 128);

DEFINE_TEST_VARIANT3(arm_rfft_q15, noisy_256, in_rfft_noisy_256,
		     ref_rfft_noisy_256, 256);

DEFINE_TEST_VARIANT3(arm_rfft_q15, noisy_512, in_rfft_noisy_512,
		     ref_rfft_noisy_512, 512);

DEFINE_TEST_VARIANT3(arm_rfft_q15, noisy_1024, in_rfft_noisy_1024,
		     ref_rfft_noisy_1024, 1024);

DEFINE_TEST_VARIANT3(arm_rfft_q15, noisy_2048, in_rfft_noisy_2048,
		     ref_rfft_noisy_2048, 2048);

DEFINE_TEST_VARIANT3(arm_rfft_q15, noisy_4096, in_rfft_noisy_4096,
		     ref_rfft_noisy_4096, 4096);

DEFINE_TEST_VARIANT3(arm_rfft_q15, step_32, in_rfft_step_32, ref_rfft_step_32,
		     32);

DEFINE_TEST_VARIANT3(arm_rfft_q15, step_64, in_rfft_step_64, ref_rfft_step_64,
		     64);

DEFINE_TEST_VARIANT3(arm_rfft_q15, step_128, in_rfft_step_128,
		     ref_rfft_step_128, 128);

DEFINE_TEST_VARIANT3(arm_rfft_q15, step_256, in_rfft_step_256,
		     ref_rfft_step_256, 256);

DEFINE_TEST_VARIANT3(arm_rfft_q15, step_512, in_rfft_step_512,
		     ref_rfft_step_512, 512);

DEFINE_TEST_VARIANT3(arm_rfft_q15, step_1024, in_rfft_step_1024,
		     ref_rfft_step_1024, 1024);

DEFINE_TEST_VARIANT3(arm_rfft_q15, step_2048, in_rfft_step_2048,
		     ref_rfft_step_2048, 2048);

DEFINE_TEST_VARIANT3(arm_rfft_q15, step_4096, in_rfft_step_4096,
		     ref_rfft_step_4096, 4096);

static void test_arm_rifft_q15(int scale_factor, const q15_t *input,
...
DEFINE_TEST_VARIANT4(arm_rifft_q15, noisy_32, 5, in_rifft_noisy_32,
		     in_rfft_noisy_32, 32);

DEFINE_TEST_VARIANT4(arm_rifft_q15, noisy_64, 6, in_rifft_noisy_64,
		     in_rfft_noisy_64, 64);

DEFINE_TEST_VARIANT4(arm_rifft_q15, noisy_128, 7, in_rifft_noisy_128,
...
DEFINE_TEST_VARIANT4(arm_rifft_q15, step_32, 5, in_rifft_step_32,
		     in_rfft_step_32, 32);

DEFINE_TEST_VARIANT4(arm_rifft_q15, step_64, 6, in_rifft_step_64,
		     in_rfft_step_64, 64);

DEFINE_TEST_VARIANT4(arm_rifft_q15, step_128, 7, in_rifft_step_128,
