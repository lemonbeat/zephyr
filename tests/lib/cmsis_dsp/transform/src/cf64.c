...
static void test_arm_cfft_f64_cmplx_backend(const arm_cfft_instance_f64 *inst,
					    bool inverse, const uint64_t *input,
...
static void test_arm_cfft_f64_cmplx(const arm_cfft_instance_f64 *inst,
				    const uint64_t *input, const uint64_t *ref,
				    size_t length)
{
...
static void test_arm_cifft_f64_cmplx(const arm_cfft_instance_f64 *inst,
				     const uint64_t *input, const uint64_t *ref,
				     size_t length)
{
