...
static void test_arm_cfft_f32_cmplx_backend(const arm_cfft_instance_f32 *inst,
					    bool inverse, const uint32_t *input,
...
static void test_arm_cfft_f32_cmplx(const arm_cfft_instance_f32 *inst,
				    const uint32_t *input, const uint32_t *ref,
				    size_t length)
{
...
static void test_arm_cifft_f32_cmplx(const arm_cfft_instance_f32 *inst,
				     const uint32_t *input, const uint32_t *ref,
				     size_t length)
{
