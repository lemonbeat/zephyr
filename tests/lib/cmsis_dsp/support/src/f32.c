...
static void test_arm_copy_f32(const uint32_t *input1, size_t length)
{
	...
	/* Validate output */
	zassert_true(test_equal_f32(length, (float32_t *)input1, output),
...
static void test_arm_fill_f32(size_t length)
{
	...
	for (index = 0; index < length; index++) {
		zassert_equal(output[index], val,
			      ASSERT_MSG_INCORRECT_COMP_RESULT);
	}
...
static void test_arm_float_to_q31(const uint32_t *input1, const q31_t *ref,
				  size_t length)
{
	q31_t *output;
	...
	/* Validate output */
	zassert_true(test_near_equal_q31(length, ref, output,
...
static void test_arm_float_to_q15(const uint32_t *input1, const q15_t *ref,
				  size_t length)
{
	q15_t *output;
	...
	/* Validate output */
	zassert_true(test_near_equal_q15(length, ref, output,
...
static void test_arm_float_to_q7(const uint32_t *input1, const q7_t *ref,
				 size_t length)
{
	q7_t *output;
	...
	/* Validate output */
	zassert_true(test_near_equal_q7(length, ref, output,
					ABS_ERROR_THRESH_Q7),
		     ASSERT_MSG_ABS_ERROR_LIMIT_EXCEED);
...
static void test_arm_weighted_sum_f32(int ref_offset, size_t length)
{
	...
	/* Validate output */
	zassert_true(test_rel_error_f32(1, output, &ref[ref_offset],
					REL_ERROR_THRESH),
...
static void test_arm_sort_out(const uint32_t *input1, const uint32_t *ref,
			      size_t length, arm_sort_alg alg, arm_sort_dir dir)
{
	float32_t *output;
	...
	/* Validate output */
	zassert_true(test_equal_f32(length, output, (float32_t *)ref),
		     ASSERT_MSG_INCORRECT_COMP_RESULT);
...
DEFINE_TEST_VARIANT5(arm_sort_out, bitonic_16, in_sort_bitonic_16,
		     ref_sort_bitonic_16, 16, ARM_SORT_BITONIC,
		     ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_out, bitonic_32, in_sort_bitonic_32,
		     ref_sort_bitonic_32, 32, ARM_SORT_BITONIC,
		     ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_out, bubble_11, in_sort, ref_sort, 11,
		     ARM_SORT_BUBBLE, ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_out, heap_11, in_sort, ref_sort, 11,
		     ARM_SORT_HEAP, ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_out, insertion_11, in_sort, ref_sort, 11,
		     ARM_SORT_INSERTION, ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_out, quick_11, in_sort, ref_sort, 11,
		     ARM_SORT_QUICK, ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_out, selection_11, in_sort, ref_sort, 11,
		     ARM_SORT_SELECTION, ARM_SORT_ASCENDING);

static void test_arm_merge_sort_out(const uint32_t *input1, const uint32_t *ref,
				    size_t length, arm_sort_dir dir)
{
	float32_t *output;
	float32_t *scratch;
...
DEFINE_TEST_VARIANT4(arm_merge_sort_out, 11, in_sort, ref_sort, 11,
		     ARM_SORT_ASCENDING);

static void test_arm_sort_in(const uint32_t *input1, const uint32_t *ref,
			     size_t length, arm_sort_alg alg, arm_sort_dir dir)
{
	float32_t *output;
	arm_sort_instance_f32 inst;
...
DEFINE_TEST_VARIANT5(arm_sort_in, bitonic_32, in_sort_bitonic_32,
		     ref_sort_bitonic_32, 32, ARM_SORT_BITONIC,
		     ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_in, bubble_11, in_sort, ref_sort, 11,
		     ARM_SORT_BUBBLE, ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_in, heap_11, in_sort, ref_sort, 11, ARM_SORT_HEAP,
		     ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_in, insertion_11, in_sort, ref_sort, 11,
		     ARM_SORT_INSERTION, ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_in, quick_11, in_sort, ref_sort, 11,
		     ARM_SORT_QUICK, ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_in, selection_11, in_sort, ref_sort, 11,
		     ARM_SORT_SELECTION, ARM_SORT_ASCENDING);

static void test_arm_sort_const(const uint32_t *input1, const uint32_t *ref,
				size_t length, arm_sort_alg alg,
				arm_sort_dir dir)
{
	float32_t *output;
	arm_sort_instance_f32 inst;
...
DEFINE_TEST_VARIANT5(arm_sort_const, bitonic_16, in_sort_const, ref_sort_const,
		     16, ARM_SORT_BITONIC, ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_const, bubble_16, in_sort_const, ref_sort_const,
		     16, ARM_SORT_BUBBLE, ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_const, heap_16, in_sort_const, ref_sort_const, 16,
		     ARM_SORT_HEAP, ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_const, insertion_16, in_sort_const,
		     ref_sort_const, 16, ARM_SORT_INSERTION,
		     ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_const, quick_16, in_sort_const, ref_sort_const,
		     16, ARM_SORT_QUICK, ARM_SORT_ASCENDING);

DEFINE_TEST_VARIANT5(arm_sort_const, selection_16, in_sort_const,
		     ref_sort_const, 16, ARM_SORT_SELECTION,
		     ARM_SORT_ASCENDING);

static void test_arm_merge_sort_const(const uint32_t *input1,
...
DEFINE_TEST_VARIANT4(arm_merge_sort_const, 16, in_sort_const, ref_sort_const,
		     16, ARM_SORT_ASCENDING);

static void test_arm_spline(const uint32_t *input_x, const uint32_t *input_y,
			    const uint32_t *input_xq, const uint32_t *ref,
			    size_t length, uint32_t n, arm_spline_type type)
{
	float32_t *output;
	float32_t *scratch;
	float32_t *coeff;
	...
	/* Initialise spline */
	arm_spline_init_f32(&inst, type, (float32_t *)input_x,
			    (float32_t *)input_y, n, coeff, scratch);
...
DEFINE_TEST_VARIANT7(arm_spline, square_20, in_spline_squ_x, in_spline_squ_y,
		     in_spline_squ_xq, ref_spline_squ, 20, 4,
		     ARM_SPLINE_PARABOLIC_RUNOUT);

DEFINE_TEST_VARIANT7(arm_spline, sine_33, in_spline_sin_x, in_spline_sin_y,
		     in_spline_sin_xq, ref_spline_sin, 33, 9,
		     ARM_SPLINE_NATURAL);

DEFINE_TEST_VARIANT7(arm_spline, ramp_30, in_spline_ram_x, in_spline_ram_y,
		     in_spline_ram_xq, ref_spline_ram, 30, 3,
		     ARM_SPLINE_PARABOLIC_RUNOUT);

void test_support_f32(void)
{
	ztest_test_suite(support_f32, ztest_unit_test(test_arm_copy_f32_3),
