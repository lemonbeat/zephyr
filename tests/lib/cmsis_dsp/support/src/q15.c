...
static void test_arm_copy_q15(const q15_t *input1, size_t length)
{
	...
	/* Validate output */
	zassert_true(test_equal_q15(length, input1, output),
...
static void test_arm_q15_to_float(const q15_t *input1, const uint32_t *ref,
				  size_t length)
{
	float32_t *output;
...
static void test_arm_q15_to_q31(const q15_t *input1, const q31_t *ref,
				size_t length)
{
	q31_t *output;
...
static void test_arm_q15_to_q7(const q15_t *input1, const q7_t *ref,
			       size_t length)
{
	q7_t *output;
...
{
	ztest_test_suite(support_q15, ztest_unit_test(test_arm_copy_q15_7),
