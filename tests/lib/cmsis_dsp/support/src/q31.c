...
static void test_arm_copy_q31(const q31_t *input1, size_t length)
{
	...
	/* Validate output */
	zassert_true(test_equal_q31(length, input1, output),
...
static void test_arm_q31_to_float(const q31_t *input1, const uint32_t *ref,
				  size_t length)
{
	float32_t *output;
	...
	/* Validate output */
	zassert_true(test_rel_error_f32(length, (float32_t *)ref, output,
					REL_ERROR_THRESH),
...
static void test_arm_q31_to_q15(const q31_t *input1, const q15_t *ref,
				size_t length)
{
	q15_t *output;
...
static void test_arm_q31_to_q7(const q31_t *input1, const q7_t *ref,
			       size_t length)
{
	q7_t *output;
...
{
	ztest_test_suite(support_q31, ztest_unit_test(test_arm_copy_q31_3),
