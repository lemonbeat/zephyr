...
static void test_arm_copy_q7(const q7_t *input1, size_t length)
{
	...
	/* Validate output */
	zassert_true(test_equal_q7(length, input1, output),
...
static void test_arm_q7_to_float(const q7_t *input1, const uint32_t *ref,
				 size_t length)
{
	float32_t *output;
	...
	/* Validate output */
	zassert_true(test_close_error_f32(length, (float32_t *)ref, output,
...
static void test_arm_q7_to_q31(const q7_t *input1, const q31_t *ref,
			       size_t length)
{
	q31_t *output;
...
static void test_arm_q7_to_q15(const q7_t *input1, const q15_t *ref,
			       size_t length)
{
	q15_t *output;
...
{
	ztest_test_suite(support_q7, ztest_unit_test(test_arm_copy_q7_15),
