...
static void test_arm_max_q7(const q7_t *input1, int ref_index, size_t length)
{
	q7_t val;
	uint32_t index;
...
static void test_arm_min_q7(const q7_t *input1, int ref_index, size_t length)
{
	q7_t val;
	uint32_t index;
...
static void test_arm_mean_q7(const q7_t *input1, int ref_index, size_t length)
{
	q7_t ref[1];
	q7_t *output;
	...
	/* Validate output */
	zassert_true(test_snr_error_q7(1, output, ref, SNR_ERROR_THRESH),
		     ASSERT_MSG_SNR_LIMIT_EXCEED);

	zassert_true(test_near_equal_q7(1, output, ref, ABS_ERROR_THRESH_Q7),
...
static void test_arm_power_q7(const q7_t *input1, int ref_index, size_t length)
{
	q31_t ref[1];
	q31_t *output;
...
{
	ztest_test_suite(statistics_q7, ztest_unit_test(test_arm_max_q7_15),
