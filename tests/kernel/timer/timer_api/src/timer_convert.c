...
static struct test_rec tests[] = {
	TESTREC(ms, cyc, floor, 32),	TESTREC(ms, cyc, floor, 64),
	TESTREC(ms, cyc, near, 32),	TESTREC(ms, cyc, near, 64),
	TESTREC(ms, cyc, ceil, 32),	TESTREC(ms, cyc, ceil, 64),
	TESTREC(ms, ticks, floor, 32),	TESTREC(ms, ticks, floor, 64),
	TESTREC(ms, ticks, near, 32),	TESTREC(ms, ticks, near, 64),
	TESTREC(ms, ticks, ceil, 32),	TESTREC(ms, ticks, ceil, 64),
	TESTREC(us, cyc, floor, 64),	TESTREC(us, cyc, near, 64),
	TESTREC(us, cyc, ceil, 64),	TESTREC(us, ticks, floor, 64),
	TESTREC(us, ticks, near, 64),	TESTREC(us, ticks, ceil, 64),
	TESTREC(cyc, ms, floor, 32),	TESTREC(cyc, ms, floor, 64),
	TESTREC(cyc, ms, near, 32),	TESTREC(cyc, ms, near, 64),
	TESTREC(cyc, ms, ceil, 32),	TESTREC(cyc, ms, ceil, 64),
	TESTREC(cyc, us, floor, 64),	TESTREC(cyc, us, near, 64),
	TESTREC(cyc, us, ceil, 64),	TESTREC(cyc, ticks, floor, 32),
	TESTREC(cyc, ticks, floor, 64), TESTREC(cyc, ticks, near, 32),
	TESTREC(cyc, ticks, near, 64),	TESTREC(cyc, ticks, ceil, 32),
	TESTREC(cyc, ticks, ceil, 64),	TESTREC(ticks, ms, floor, 32),
	TESTREC(ticks, ms, floor, 64),	TESTREC(ticks, ms, near, 32),
	TESTREC(ticks, ms, near, 64),	TESTREC(ticks, ms, ceil, 32),
	TESTREC(ticks, ms, ceil, 64),	TESTREC(ticks, us, floor, 64),
	TESTREC(ticks, us, near, 64),	TESTREC(ticks, us, ceil, 64),
	TESTREC(ticks, cyc, floor, 32), TESTREC(ticks, cyc, floor, 64),
	TESTREC(ticks, cyc, near, 32),	TESTREC(ticks, cyc, near, 64),
	TESTREC(ticks, cyc, ceil, 32),	TESTREC(ticks, cyc, ceil, 64),
	TESTREC(ns, cyc, floor, 64),	TESTREC(ns, cyc, near, 64),
	TESTREC(ns, cyc, ceil, 64),	TESTREC(ns, ticks, floor, 64),
	TESTREC(ns, ticks, near, 64),	TESTREC(ns, ticks, ceil, 64),
	TESTREC(cyc, ns, floor, 64),	TESTREC(cyc, ns, near, 64),
	TESTREC(cyc, ns, ceil, 64),	TESTREC(ticks, ns, floor, 64),
	TESTREC(ticks, ns, near, 64),	TESTREC(ticks, ns, ceil, 64),
};
