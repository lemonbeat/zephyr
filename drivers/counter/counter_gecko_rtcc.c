...
#define DEV_CFG(dev) ((const struct counter_gecko_config *const)(dev)->config)
#define DEV_DATA(dev) ((struct counter_gecko_data *const)(dev)->data)
...
DEVICE_AND_API_INIT(counter_gecko_0, DT_INST_LABEL(0), counter_gecko_init,
