...
#define XTHAL_SET_CCOUNT(v)                          \
	do {                                         \
		int __ccount = (int)(v);             \
		__asm__ __volatile__("wsr.ccount %0" \
				     :               \
				     : "a"(__ccount) \
				     : "memory");    \
	} while (0)
 ...
 */
#define GET_HP_VOLTAGE \
	(RTC_CNTL_DBIAS_1V25 - ((EFUSE_BLK0_RDATA5_REG >> 22) & 0x3))
