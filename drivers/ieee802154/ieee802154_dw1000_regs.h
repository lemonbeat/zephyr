...
#define DWT_SYS_STATUS_ALL_RX_GOOD                                            \
	(DWT_SYS_STATUS_RXDFR | DWT_SYS_STATUS_RXFCG | DWT_SYS_STATUS_RXPRD | \
	 DWT_SYS_STATUS_RXSFDD | DWT_SYS_STATUS_RXPHD)
/* All TX events mask. */
#define DWT_SYS_STATUS_ALL_TX                                               \
	(DWT_SYS_STATUS_AAT | DWT_SYS_STATUS_TXFRB | DWT_SYS_STATUS_TXPRS | \
	 DWT_SYS_STATUS_TXPHS | DWT_SYS_STATUS_TXFRS)
/* All double buffer events mask. */
#define DWT_SYS_STATUS_ALL_DBLBUFF (DWT_SYS_STATUS_RXDFR | DWT_SYS_STATUS_RXFCG)
/* All RX errors mask. */
#define DWT_SYS_STATUS_ALL_RX_ERR                                              \
	(DWT_SYS_STATUS_RXPHE | DWT_SYS_STATUS_RXFCE | DWT_SYS_STATUS_RXRFSL | \
	 DWT_SYS_STATUS_RXOVRR | DWT_SYS_STATUS_RXSFDTO |                      \
	 DWT_SYS_STATUS_AFFREJ)
#define DWT_SYS_MASK_ALL_RX_ERR                                             \
	(DWT_SYS_MASK_MRXPHE | DWT_SYS_MASK_MRXFCE | DWT_SYS_MASK_MRXRFSL | \
 ...
 */
#define DWT_SYS_STATUS_ALL_RX_TO (DWT_SYS_STATUS_RXRFTO | DWT_SYS_STATUS_RXPTO)
#define DWT_SYS_MASK_ALL_RX_TO (DWT_SYS_MASK_MRXRFTO | DWT_SYS_MASK_MRXPTO)
...
#define DWT_RF_CONF_TXPLLPOWEN_MASK \
	(DWT_RF_CONF_PLLEN_MASK | DWT_RF_CONF_TXPOW_MASK)
#define DWT_RF_CONF_TXALLEN_MASK                          \
	(DWT_RF_CONF_TXEN_MASK | DWT_RF_CONF_TXPOW_MASK | \
	 DWT_RF_CONF_PLLEN_MASK | DWT_RF_CONF_TXBLOCKSEN_MASK)
...
const uint32_t dwt_txctrl_defs[] = {
	DWT_RF_TXCTRL_CH1, DWT_RF_TXCTRL_CH2, DWT_RF_TXCTRL_CH3,
	DWT_RF_TXCTRL_CH4, DWT_RF_TXCTRL_CH5, DWT_RF_TXCTRL_CH7,
};

/* Defaults from Table 43: Sub-Register 0x2B:07 – FS_PLLCFG values */
const uint32_t dwt_pllcfg_defs[] = { DWT_FS_PLLCFG_CH1, DWT_FS_PLLCFG_CH2,
				     DWT_FS_PLLCFG_CH3, DWT_FS_PLLCFG_CH4,
				     DWT_FS_PLLCFG_CH5, DWT_FS_PLLCFG_CH7 };

/* Defaults from Table 44: Sub-Register 0x2B:0B – FS_PLLTUNE values */
const uint8_t dwt_plltune_defs[] = { DWT_FS_PLLTUNE_CH1, DWT_FS_PLLTUNE_CH2,
				     DWT_FS_PLLTUNE_CH3, DWT_FS_PLLTUNE_CH4,
				     DWT_FS_PLLTUNE_CH5, DWT_FS_PLLTUNE_CH7 };

/* Defaults from Table 37: Sub-Register 0x28:0B– RF_RXCTRLH values */
const uint8_t dwt_rxctrlh_defs[] = { DWT_RF_RXCTRLH_NBW, DWT_RF_RXCTRLH_NBW,
				     DWT_RF_RXCTRLH_NBW, DWT_RF_RXCTRLH_WBW,
				     DWT_RF_RXCTRLH_NBW, DWT_RF_RXCTRLH_WBW };

/* Defaults from Table 40: Sub-Register 0x2A:0B – TC_PGDELAY */
const uint8_t dwt_pgdelay_defs[] = { DWT_TC_PGDELAY_CH1, DWT_TC_PGDELAY_CH2,
				     DWT_TC_PGDELAY_CH3, DWT_TC_PGDELAY_CH4,
				     DWT_TC_PGDELAY_CH5, DWT_TC_PGDELAY_CH7 };
 ...
 */
const uint32_t dwt_txpwr_stxp0_16[] = { 0x15355575, 0x15355575, 0x0F2F4F6F,
					0x1F1F3F5F, 0x0E082848, 0x32527292 };
 ...
 */
const uint32_t dwt_txpwr_stxp0_64[] = { 0x07274767, 0x07274767, 0x2B4B6B8B,
					0x3A5A7A9A, 0x25456585, 0x5171B1D1 };
 ...
 */
const uint32_t dwt_txpwr_stxp1_16[] = { 0x75757575, 0x75757575, 0x6F6F6F6F,
					0x5F5F5F5F, 0x48484848, 0x92929292 };
 ...
 */
const uint32_t dwt_txpwr_stxp1_64[] = { 0x67676767, 0x67676767, 0x8B8B8B8B,
					0x9A9A9A9A, 0x85858585, 0xD1D1D1D1 };
...
const uint16_t dwt_agc_tune1_defs[] = { DWT_AGC_TUNE1_16M, DWT_AGC_TUNE1_64M };
...
const uint8_t dwt_ns_sfdlen[] = { DWT_DW_NS_SFD_LEN_110K,
...
const uint16_t dwt_tune0b_defs[DWT_NUMOF_BRS][2] = {
	{ DWT_DRX_TUNE0b_110K_STD, DWT_DRX_TUNE0b_110K_NSTD },
	{ DWT_DRX_TUNE0b_850K_STD, DWT_DRX_TUNE0b_850K_NSTD },
	{ DWT_DRX_TUNE0b_6M8_STD, DWT_DRX_TUNE0b_6M8_NSTD }
};

/* Defaults from Table 31: Sub-Register 0x27:04 – DRX_TUNE1a values */
const uint16_t dwt_tune1a_defs[] = { DWT_DRX_TUNE1a_PRF16,
...
const uint32_t dwt_tune2_defs[DWT_NUMOF_PRFS][DWT_NUMOF_PACS] = {
	{ DWT_DRX_TUNE2_PRF16_PAC8, DWT_DRX_TUNE2_PRF16_PAC16,
	  DWT_DRX_TUNE2_PRF16_PAC32, DWT_DRX_TUNE2_PRF16_PAC64 },
	{ DWT_DRX_TUNE2_PRF64_PAC8, DWT_DRX_TUNE2_PRF64_PAC16,
	  DWT_DRX_TUNE2_PRF64_PAC32, DWT_DRX_TUNE2_PRF64_PAC64 }
};
 ...
 */
const uint16_t dwt_lde_repc_defs[] = { 0,
...
const uint32_t dwt_plen_cfg[] = {
	(0 | BIT(18) | 0 | 0),	     (0 | BIT(18) | 0 | BIT(20)),
	(0 | BIT(18) | BIT(21) | 0), (0 | BIT(18) | BIT(21) | BIT(20)),
	(BIT(19) | 0 | 0 | 0),	     (BIT(19) | 0 | BIT(21) | 0),
	(BIT(19) | BIT(18) | 0 | 0),
};
