...
#define FRMFILT1_ACCEPT_ALL                                        \
	(FRMFILT1_ACCEPT_FT_0_BEACON | FRMFILT1_ACCEPT_FT_1_DATA | \
	 FRMFILT1_ACCEPT_FT_2_ACK | FRMFILT1_ACCEPT_FT_3_MAC_CMD)
...
#define SRCMATCH_DEFAULTS \
	(SRCMATCH_SRC_MATCH_EN | SRCMATCH_AUTOPEND | SRCMATCH_PEND_DATAREQ_ONLY)
...
#define EXCFLAG0_RESET_TX_FLAGS                                    \
	((uint8_t) ~(EXCFLAG0_TX_FRM_DONE | EXCFLAG0_TX_ACK_DONE | \
		     EXCFLAG0_TX_UNDERFLOW | EXCFLAG0_TX_OVERFLOW))
#define EXCFLAG0_RESET_RX_FLAGS                                     \
	((uint8_t) ~(EXCFLAG0_RX_UNDERFLOW | EXCFLAG0_RX_OVERFLOW | \
...
#define EXCFLAG1_RESET_RX_FLAGS                                        \
	((uint8_t) ~(EXCFLAG1_RX_FRM_DONE | EXCFLAG1_RX_FRM_ACCEPTED | \
		     EXCFLAG1_FIFOP))
...
#define CC2520_MEM_KEY (CC2520_MEM_START + CC2520_MEM_KEY_POS)
#define CC2520_MEM_NONCE_POS (0xa0)
#define CC2520_MEM_NONCE (CC2520_MEM_START + CC2520_MEM_NONCE_POS)
