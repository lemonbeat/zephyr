...
#define FLASH_SYNC_SWITCHING_TIME \
	(FLASH_RADIO_ABORT_DELAY_US + FLASH_RADIO_WORK_DELAY_US)
				     ...
				     void *context)
{
	...
	time_slot_delay(ticks_at_expire,
			...
			time_slot_callback_work, context);
}
				       ...
				       void *context)
{
	...
	time_slot_delay(ticks_at_expire,
			...
			time_slot_callback_abort, context);
