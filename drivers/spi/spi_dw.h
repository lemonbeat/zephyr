 ...
 */
#define SPI_WS_TO_DFS(__bpw) \
	(((__bpw) & ~0x38) ? (((__bpw) / 8) + 1) : ((__bpw) / 8))
...
#define DW_SPI_ISR_ERRORS_MASK                                    \
	(DW_SPI_ISR_TXOIS | DW_SPI_ISR_RXUIS | DW_SPI_ISR_RXOIS | \
	 DW_SPI_ISR_MSTIS)
/* ICR Bit */
...
#define DW_SPI_IMR_UNMASK                                         \
	(DW_SPI_IMR_TXEIM | DW_SPI_IMR_TXOIM | DW_SPI_IMR_RXUIM | \
	 DW_SPI_IMR_RXOIM | DW_SPI_IMR_RXFIM)
#define DW_SPI_IMR_MASK_TX (~(DW_SPI_IMR_TXEIM | DW_SPI_IMR_TXOIM))
#define DW_SPI_IMR_MASK_RX \
	(~(DW_SPI_IMR_RXUIM | DW_SPI_IMR_RXOIM | DW_SPI_IMR_RXFIM))
