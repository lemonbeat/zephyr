...
static int gpio_xec_configure(const struct device *dev, gpio_pin_t pin,
			      gpio_flags_t flags)
{
...
static int gpio_xec_port_set_masked_raw(const struct device *dev, uint32_t mask,
					uint32_t value)
{
	const struct gpio_xec_config *config = dev->config;
...
DEVICE_AND_API_INIT(gpio_xec_port000_036, DT_LABEL(DT_NODELABEL(gpio_000_036)),
		    gpio_xec_port000_036_init, &gpio_xec_port000_036_data,
		    &gpio_xec_port000_036_config, POST_KERNEL,
		    CONFIG_KERNEL_INIT_PRIORITY_DEFAULT, &gpio_xec_driver_api);
...
static int gpio_xec_port000_036_init(const struct device *dev)
{
	...
	IRQ_CONNECT(DT_IRQ(DT_NODELABEL(gpio_000_036), irq),
		    ...
		    gpio_gpio_xec_port_isr, DEVICE_GET(gpio_xec_port000_036),
		    0U);
...
DEVICE_AND_API_INIT(gpio_xec_port040_076, DT_LABEL(DT_NODELABEL(gpio_040_076)),
		    gpio_xec_port040_076_init, &gpio_xec_port040_076_data,
		    &gpio_xec_port040_076_config, POST_KERNEL,
		    CONFIG_KERNEL_INIT_PRIORITY_DEFAULT, &gpio_xec_driver_api);
...
static int gpio_xec_port040_076_init(const struct device *dev)
{
	...
	IRQ_CONNECT(DT_IRQ(DT_NODELABEL(gpio_040_076), irq),
		    ...
		    gpio_gpio_xec_port_isr, DEVICE_GET(gpio_xec_port040_076),
		    0U);
...
DEVICE_AND_API_INIT(gpio_xec_port100_136, DT_LABEL(DT_NODELABEL(gpio_100_136)),
		    gpio_xec_port100_136_init, &gpio_xec_port100_136_data,
		    &gpio_xec_port100_136_config, POST_KERNEL,
		    CONFIG_KERNEL_INIT_PRIORITY_DEFAULT, &gpio_xec_driver_api);
...
static int gpio_xec_port100_136_init(const struct device *dev)
{
	...
	IRQ_CONNECT(DT_IRQ(DT_NODELABEL(gpio_100_136), irq),
		    ...
		    gpio_gpio_xec_port_isr, DEVICE_GET(gpio_xec_port100_136),
		    0U);
...
DEVICE_AND_API_INIT(gpio_xec_port140_176, DT_LABEL(DT_NODELABEL(gpio_140_176)),
		    gpio_xec_port140_176_init, &gpio_xec_port140_176_data,
		    &gpio_xec_port140_176_config, POST_KERNEL,
		    CONFIG_KERNEL_INIT_PRIORITY_DEFAULT, &gpio_xec_driver_api);
...
static int gpio_xec_port140_176_init(const struct device *dev)
{
	...
	IRQ_CONNECT(DT_IRQ(DT_NODELABEL(gpio_140_176), irq),
		    ...
		    gpio_gpio_xec_port_isr, DEVICE_GET(gpio_xec_port140_176),
		    0U);
...
DEVICE_AND_API_INIT(gpio_xec_port200_236, DT_LABEL(DT_NODELABEL(gpio_200_236)),
		    gpio_xec_port200_236_init, &gpio_xec_port200_236_data,
		    &gpio_xec_port200_236_config, POST_KERNEL,
		    CONFIG_KERNEL_INIT_PRIORITY_DEFAULT, &gpio_xec_driver_api);
...
static int gpio_xec_port200_236_init(const struct device *dev)
{
	...
	IRQ_CONNECT(DT_IRQ(DT_NODELABEL(gpio_200_236), irq),
		    ...
		    gpio_gpio_xec_port_isr, DEVICE_GET(gpio_xec_port200_236),
		    0U);
...
DEVICE_AND_API_INIT(gpio_xec_port240_276, DT_LABEL(DT_NODELABEL(gpio_240_276)),
		    gpio_xec_port240_276_init, &gpio_xec_port240_276_data,
		    &gpio_xec_port240_276_config, POST_KERNEL,
		    CONFIG_KERNEL_INIT_PRIORITY_DEFAULT, &gpio_xec_driver_api);
...
static int gpio_xec_port240_276_init(const struct device *dev)
{
	...
	IRQ_CONNECT(DT_IRQ(DT_NODELABEL(gpio_240_276), irq),
		    ...
		    gpio_gpio_xec_port_isr, DEVICE_GET(gpio_xec_port240_276),
		    0U);
