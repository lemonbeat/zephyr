...
#define DEV_CFG(dev) ((const struct mcux_iuart_config *const)(dev)->config)
...
#define IUART_MCUX_INIT(n)                                                    \
	...
	static const struct mcux_iuart_config mcux_iuart_##n##_config;        \
                                                                              \
	DEVICE_AND_API_INIT(uart_##n, DT_INST_LABEL(n), &mcux_iuart_init,     \
			    &mcux_iuart_##n##_data, &mcux_iuart_##n##_config, \
