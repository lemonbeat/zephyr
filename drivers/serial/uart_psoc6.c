...
DEVICE_AND_API_INIT(uart_5, DT_LABEL(DT_NODELABEL(uart5)), uart_psoc6_init,
		    NULL, &cypress_psoc6_uart5_config, PRE_KERNEL_1,
...
DEVICE_AND_API_INIT(uart_6, DT_LABEL(DT_NODELABEL(uart6)), uart_psoc6_init,
		    NULL, &cypress_psoc6_uart6_config, PRE_KERNEL_1,
		    CONFIG_KERNEL_INIT_PRIORITY_DEVICE,
		    (void *)&uart_psoc6_driver_api);
