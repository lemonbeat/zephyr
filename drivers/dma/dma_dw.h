...
#define DW_SAR(chan) (0x0000 + BYT_CHAN_OFFSET(chan))
#define DW_DAR(chan) (0x0008 + BYT_CHAN_OFFSET(chan))
#define DW_LLP(chan) (0x0010 + BYT_CHAN_OFFSET(chan))
#define DW_CTRL_LOW(chan) (0x0018 + BYT_CHAN_OFFSET(chan))
#define DW_CTRL_HIGH(chan) (0x001C + BYT_CHAN_OFFSET(chan))
#define DW_CFG_LOW(chan) (0x0040 + BYT_CHAN_OFFSET(chan))
#define DW_CFG_HIGH(chan) (0x0044 + BYT_CHAN_OFFSET(chan))
