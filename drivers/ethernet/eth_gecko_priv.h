...
#define DEV_CFG(dev) ((const struct eth_gecko_dev_cfg *)(dev)->config)
#define DEV_DATA(dev) ((struct eth_gecko_dev_data *)(dev)->data)

/* PHY Management pins */
#define PIN_PHY_MDC                                                  \
	{                                                            \
		DT_INST_PROP_BY_IDX(0, location_phy_mdc, 1),         \
			DT_INST_PROP_BY_IDX(0, location_phy_mdc, 2), \
			gpioModePushPull, 0                          \
	}
#define PIN_PHY_MDIO                                                  \
	{                                                             \
		DT_INST_PROP_BY_IDX(0, location_phy_mdio, 1),         \
			DT_INST_PROP_BY_IDX(0, location_phy_mdio, 2), \
			gpioModePushPull, 0                           \
	}

#define PIN_LIST_PHY                      \
	{                                 \
		PIN_PHY_MDC, PIN_PHY_MDIO \
	}

/* RMII pins excluding reference clock, handled by board.c */
#define PIN_RMII_CRSDV                                                   \
	{                                                                \
		DT_INST_PROP_BY_IDX(0, location_rmii_crs_dv, 1),         \
			DT_INST_PROP_BY_IDX(0, location_rmii_crs_dv, 2), \
			gpioModeInput, 0                                 \
	}

#define PIN_RMII_TXD0                                                  \
	{                                                              \
		DT_INST_PROP_BY_IDX(0, location_rmii_txd0, 1),         \
			DT_INST_PROP_BY_IDX(0, location_rmii_txd0, 2), \
			gpioModePushPull, 0                            \
	}

#define PIN_RMII_TXD1                                                  \
	{                                                              \
		DT_INST_PROP_BY_IDX(0, location_rmii_txd1, 1),         \
			DT_INST_PROP_BY_IDX(0, location_rmii_txd1, 2), \
			gpioModePushPull, 0                            \
	}

#define PIN_RMII_TX_EN                                                  \
	{                                                               \
		DT_INST_PROP_BY_IDX(0, location_rmii_tx_en, 1),         \
			DT_INST_PROP_BY_IDX(0, location_rmii_tx_en, 2), \
			gpioModePushPull, 0                             \
	}

#define PIN_RMII_RXD0                                                  \
	{                                                              \
		DT_INST_PROP_BY_IDX(0, location_rmii_rxd0, 1),         \
			DT_INST_PROP_BY_IDX(0, location_rmii_rxd0, 2), \
			gpioModeInput, 0                               \
	}

#define PIN_RMII_RXD1                                                  \
	{                                                              \
		DT_INST_PROP_BY_IDX(0, location_rmii_rxd1, 1),         \
			DT_INST_PROP_BY_IDX(0, location_rmii_rxd1, 2), \
			gpioModeInput, 0                               \
	}

#define PIN_RMII_RX_ER                                                  \
	{                                                               \
		DT_INST_PROP_BY_IDX(0, location_rmii_rx_er, 1),         \
			DT_INST_PROP_BY_IDX(0, location_rmii_rx_er, 2), \
			gpioModeInput, 0                                \
	}

#define PIN_LIST_RMII                                                         \
	{                                                                     \
		PIN_RMII_CRSDV, PIN_RMII_TXD0, PIN_RMII_TXD1, PIN_RMII_TX_EN, \
			PIN_RMII_RXD0, PIN_RMII_RXD1, PIN_RMII_RX_ER          \
	}
