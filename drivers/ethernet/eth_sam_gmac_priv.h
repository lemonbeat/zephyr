...
#define GMAC_INT_RX_ERR_BITS (GMAC_IER_RXUBR | GMAC_IER_ROVR)
#define GMAC_INT_TX_ERR_BITS (GMAC_IER_TUR | GMAC_IER_RLEX | GMAC_IER_TFC)
#define GMAC_INT_EN_FLAGS                                         \
	(GMAC_IER_RCOMP | GMAC_INT_RX_ERR_BITS | GMAC_IER_TCOMP | \
	 GMAC_INT_TX_ERR_BITS | GMAC_IER_HRESP)

#define GMAC_INTPQ_RX_ERR_BITS (GMAC_IERPQ_RXUBR | GMAC_IERPQ_ROVR)
#define GMAC_INTPQ_TX_ERR_BITS (GMAC_IERPQ_RLEX | GMAC_IERPQ_TFC)
#define GMAC_INTPQ_EN_FLAGS                                             \
	(GMAC_IERPQ_RCOMP | GMAC_INTPQ_RX_ERR_BITS | GMAC_IERPQ_TCOMP | \
	 GMAC_INTPQ_TX_ERR_BITS | GMAC_IERPQ_HRESP)
...
#define GMAC_DMA_QUEUE_FLAGS \
	(GMAC_DCFGR_RXBMS_FULL | GMAC_DCFGR_TXPBMS | GMAC_DCFGR_TXCOEN)
#else
...
#define DEV_CFG(dev) ((const struct eth_sam_dev_cfg *const)(dev)->config)
#define DEV_DATA(dev) ((struct eth_sam_dev_data *const)(dev)->data)
