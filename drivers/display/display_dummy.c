...
static void
dummy_display_get_capabilities(const struct device *dev,
...
static int
dummy_display_set_pixel_format(const struct device *dev,
...
DEVICE_AND_API_INIT(dummy_display, CONFIG_DUMMY_DISPLAY_DEV_NAME,
		    &dummy_display_init, &dummy_display_data, NULL, APPLICATION,
		    CONFIG_APPLICATION_INIT_PRIORITY, &dummy_display_api);
