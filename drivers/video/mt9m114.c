...
static inline int i2c_burst_read16(const struct device *dev, uint16_t dev_addr,
...
static inline int i2c_burst_write16(const struct device *dev, uint16_t dev_addr,
...
DEVICE_AND_API_INIT(mt9m114, DT_INST_LABEL(0), &mt9m114_init_0, &mt9m114_data_0,
