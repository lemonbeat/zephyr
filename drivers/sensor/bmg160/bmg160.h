...
#if defined(CONFIG_BMG160_RANGE_RUNTIME) || defined(CONFIG_BMG160_RANGE_2000DPS)
...
#if defined(CONFIG_BMG160_ODR_RUNTIME) || defined(CONFIG_BMG160_ODR_100)
...
int bmg160_update_byte(const struct device *dev, uint8_t reg_addr, uint8_t mask,
		       uint8_t value);
int bmg160_write_byte(const struct device *dev, uint8_t reg_addr, uint8_t data);
