			       ...
			       struct adxl345_sample *sample)
{
	...
	int rc = i2c_burst_read(data->i2c_master, data->i2c_addr,
				ADXL345_X_AXIS_DATA_0_REG, axis_data, 6);
...
DEVICE_AND_API_INIT(adxl345, DT_INST_LABEL(0), adxl345_init, &adxl345_data,
		    &adxl345_config, POST_KERNEL, CONFIG_SENSOR_INIT_PRIORITY,
		    &adxl345_api_funcs);
