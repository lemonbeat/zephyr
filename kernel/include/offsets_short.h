 ...
 */
#define _kernel_offset_to_nested (___cpu_t_nested_OFFSET)

#define _kernel_offset_to_irq_stack (___cpu_t_irq_stack_OFFSET)

#define _kernel_offset_to_current (___cpu_t_current_OFFSET)
#endif /* CONFIG_SMP */

#define _kernel_offset_to_idle (___kernel_t_idle_OFFSET)

#define _kernel_offset_to_current_fp (___kernel_t_current_fp_OFFSET)
...
#define _thread_offset_to_callee_saved (___thread_t_callee_saved_OFFSET)
