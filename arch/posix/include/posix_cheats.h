...
#if !defined(ZEPHYR_ARCH_POSIX_INCLUDE_POSIX_CHEATS_H_) && \
	!defined(NO_POSIX_CHEATS)
...
#define pthread_rwlock_tryrdlock(...) zap_pthread_rwlock_tryrdlock(__VA_ARGS__)
#define pthread_rwlock_trywrlock(...) zap_pthread_rwlock_trywrlock(__VA_ARGS__)
