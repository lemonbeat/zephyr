...
#define LP503X_LED_COL1_CHAN(led) \
	(LP503X_LED_COL_CHAN_BASE + led * LP503X_COLORS_PER_LED)
#define LP503X_LED_COL2_CHAN(led) \
	(LP503X_LED_COL_CHAN_BASE + led * LP503X_COLORS_PER_LED + 1)
#define LP503X_LED_COL3_CHAN(led) \
	(LP503X_LED_COL_CHAN_BASE + led * LP503X_COLORS_PER_LED + 2)
