...
#define ESP32_SECUREBOOT_MODULE \
	35 /* Secure boot reset will hold SHA & AES in reset */
#define ESP32_DIGITAL_SIGNATURE_MODULE \
	36 /* Digital signature reset will hold AES & RSA in reset */
