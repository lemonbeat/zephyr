...
#define BT_FEAT_LE_CONN_PARAM_REQ_PROC(feat) \
	BT_LE_FEAT_TEST(feat, BT_LE_FEAT_BIT_CONN_PARAM_REQ)
#define BT_FEAT_LE_SLAVE_FEATURE_XCHG(feat) \
	BT_LE_FEAT_TEST(feat, BT_LE_FEAT_BIT_SLAVE_FEAT_REQ)
...
#define BT_FEAT_LE_PHY_CODED(feat) \
	BT_LE_FEAT_TEST(feat, BT_LE_FEAT_BIT_PHY_CODED)
...
#define BT_FEAT_LE_EXT_PER_ADV(feat) \
	BT_LE_FEAT_TEST(feat, BT_LE_FEAT_BIT_PER_ADV)
#define BT_FEAT_LE_CIS_MASTER(feat) \
	BT_LE_FEAT_TEST(feat, BT_LE_FEAT_BIT_CIS_MASTER)
#define BT_FEAT_LE_CIS_SLAVE(feat) \
	BT_LE_FEAT_TEST(feat, BT_LE_FEAT_BIT_CIS_SLAVE)
#define BT_FEAT_LE_ISO_BROADCASTER(feat) \
	BT_LE_FEAT_TEST(feat, BT_LE_FEAT_BIT_ISO_BROADCASTER)
#define BT_FEAT_LE_SYNC_RECEIVER(feat) \
	BT_LE_FEAT_TEST(feat, BT_LE_FEAT_BIT_SYNC_RECEIVER)
#define BT_FEAT_LE_ISO_CHANNELS(feat) \
	BT_LE_FEAT_TEST(feat, BT_LE_FEAT_BIT_ISO_CHANNELS)

#define BT_FEAT_LE_CIS(feat) \
	(BT_FEAT_LE_CIS_MASTER(feat) | BT_FEAT_LE_CIS_SLAVE(feat))
#define BT_FEAT_LE_BIS(feat) \
	(BT_FEAT_LE_ISO_BROADCASTER(feat) | BT_FEAT_LE_SYNC_RECEIVER(feat))
...
#define ESCO_PKT_MASK \
	(HCI_PKT_TYPE_ESCO_HV1 | HCI_PKT_TYPE_ESCO_HV2 | HCI_PKT_TYPE_ESCO_HV3)
#define SCO_PKT_MASK (HCI_PKT_TYPE_HV1 | HCI_PKT_TYPE_HV2 | HCI_PKT_TYPE_HV3)
#define EDR_ESCO_PKT_MASK                                  \
	(HCI_PKT_TYPE_ESCO_2EV3 | HCI_PKT_TYPE_ESCO_3EV3 | \
