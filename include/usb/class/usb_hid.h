...
#define HID_ITEM(bTag, bType, bSize) \
	(((bTag & 0xF) << 4) | ((bType & 0x3) << 2) | (bSize & 0x3))
...
#define HID_MI_COLLECTION_END HID_MAIN_ITEM(ITEM_TAG_COLLECTION_END, 0)
...
#define HID_GI_LOGICAL_MIN(size) HID_GLOBAL_ITEM(ITEM_TAG_LOGICAL_MIN, size)
#define HID_GI_LOGICAL_MAX(size) HID_GLOBAL_ITEM(ITEM_TAG_LOGICAL_MAX, size)
#define HID_GI_REPORT_SIZE HID_GLOBAL_ITEM(ITEM_TAG_REPORT_SIZE, 1)
#define HID_GI_REPORT_ID HID_GLOBAL_ITEM(ITEM_TAG_REPORT_ID, 1)
#define HID_GI_REPORT_COUNT HID_GLOBAL_ITEM(ITEM_TAG_REPORT_COUNT, 1)

#define HID_LI_USAGE HID_LOCAL_ITEM(ITEM_TAG_USAGE, 1)
#define HID_LI_USAGE_MIN(size) HID_LOCAL_ITEM(ITEM_TAG_USAGE_MIN, size)
#define HID_LI_USAGE_MAX(size) HID_LOCAL_ITEM(ITEM_TAG_USAGE_MAX, size)
...
#define HID_MOUSE_REPORT_DESC(bcnt)                                                                          \
	{                                                                                                    \
		...
		HID_GI_USAGE_PAGE, USAGE_GEN_DESKTOP, /* USAGE (Mouse) */                                    \
			HID_LI_USAGE,                                                                        \
			USAGE_GEN_DESKTOP_MOUSE, /* COLLECTION (Application) */                              \
			HID_MI_COLLECTION,                                                                   \
			COLLECTION_APPLICATION, /* USAGE (Pointer) */                                        \
			HID_LI_USAGE,                                                                        \
			USAGE_GEN_DESKTOP_POINTER, /* COLLECTION (Physical) */                               \
			HID_MI_COLLECTION,                                                                   \
			COLLECTION_PHYSICAL, /* Bits used for button signalling */ /* USAGE_PAGE (Button) */ \
			HID_GI_USAGE_PAGE,                                                                   \
			USAGE_GEN_BUTTON, /* USAGE_MINIMUM (Button 1) */                                     \
			HID_LI_USAGE_MIN(1),                                                                 \
			0x01, /* USAGE_MAXIMUM (Button bcnt) */                                              \
			...
			HID_MI_INPUT,                                                                        \
			0x02, /* Unused bits */ /* REPORT_SIZE (8 - bcnt) */                                 \
			HID_GI_REPORT_SIZE, (8 - bcnt), /* REPORT_COUNT (1) */                               \
			HID_GI_REPORT_COUNT, 0x01, /* INPUT (Cnst,Ary,Abs) */                                \
			HID_MI_INPUT,                                                                        \
			0x01, /* X and Y axis, scroll */ /* USAGE_PAGE (Generic Desktop) */                  \
			...
			HID_LI_USAGE,                                                                        \
			USAGE_GEN_DESKTOP_WHEEL, /* LOGICAL_MINIMUM (-127) */                                \
...
#define HID_KEYBOARD_REPORT_DESC()                                                           \
	{                                                                                    \
		...
		HID_GI_USAGE_PAGE, USAGE_GEN_DESKTOP, /* USAGE (Keyboard) */                 \
			HID_LI_USAGE,                                                        \
			USAGE_GEN_DESKTOP_KEYBOARD, /* COLLECTION (Application) */           \
			HID_MI_COLLECTION,                                                   \
			COLLECTION_APPLICATION, /* USAGE_PAGE (Keypad) */                    \
			HID_GI_USAGE_PAGE,                                                   \
			USAGE_GEN_DESKTOP_KEYPAD, /* USAGE_MINIMUM (Keyboard LeftControl) */ \
			HID_LI_USAGE_MIN(1),                                                 \
			0xE0, /* USAGE_MAXIMUM (Keyboard Right GUI) */                       \
			...
			HID_GI_USAGE_PAGE,                                                   \
			USAGE_GEN_LEDS, /* USAGE_MINIMUM (Num Lock) */                       \
			...
			HID_GI_LOGICAL_MIN(1),                                               \
			0x00, /* LOGICAL_MAXIMUM (101) */                                    \
			HID_GI_LOGICAL_MAX(1), 0x65, /* USAGE_PAGE (Keypad) */               \
			HID_GI_USAGE_PAGE,                                                   \
			USAGE_GEN_DESKTOP_KEYPAD, /* USAGE_MINIMUM (Reserved) */             \
			HID_LI_USAGE_MIN(1),                                                 \
			0x00, /* USAGE_MAXIMUM (Keyboard Application) */                     \
...
int hid_int_ep_read(const struct device *dev, uint8_t *data,
		    uint32_t max_data_len, uint32_t *ret_bytes);
