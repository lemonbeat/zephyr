...
#define Z_GENLIST_PEEK_NEXT_CONTAINER(__lname, __cn, __n)                  \
	((__cn) ? Z_GENLIST_CONTAINER(                                     \
			  sys_##__lname##_peek_next(&((__cn)->__n)), __cn, \
			  __n) :                                           \
			NULL)
...
#define Z_GENLIST_PEEK_NEXT_NO_CHECK(__lname, __nname)                       \
	static inline sys_##__nname##_t *sys_##__lname##_peek_next_no_check( \
...
#define Z_GENLIST_PEEK_NEXT(__lname, __nname)                             \
	static inline sys_##__nname##_t *sys_##__lname##_peek_next(       \
		sys_##__nname##_t *node)                                  \
	{                                                                 \
		return node != NULL ?                                     \
...
#define Z_GENLIST_PREPEND(__lname, __nname)                                    \
	static inline void sys_##__lname##_prepend(sys_##__lname##_t *list,    \
						   sys_##__nname##_t *node)    \
	{                                                                      \
		...
		if (sys_##__lname##_peek_tail(list) == NULL) {                 \
			z_##__lname##_tail_set(                                \
				list, sys_##__lname##_peek_head(list));        \
		}                                                              \
	}

#define Z_GENLIST_APPEND(__lname, __nname)                                 \
	static inline void sys_##__lname##_append(sys_##__lname##_t *list, \
						  sys_##__nname##_t *node) \
	{                                                                  \
...
#define Z_GENLIST_APPEND_LIST(__lname, __nname)                            \
	static inline void sys_##__lname##_append_list(                    \
		sys_##__lname##_t *list, void *head, void *tail)           \
	{                                                                  \
		if (sys_##__lname##_peek_tail(list) == NULL) {             \
...
#define Z_GENLIST_MERGE_LIST(__lname, __nname)                              \
	static inline void sys_##__lname##_merge_##__lname(                 \
		sys_##__lname##_t *list, sys_##__lname##_t *list_to_append) \
	{                                                                   \
...
#define Z_GENLIST_INSERT(__lname, __nname)                                     \
	static inline void sys_##__lname##_insert(sys_##__lname##_t *list,     \
...
#define Z_GENLIST_GET_NOT_EMPTY(__lname, __nname)                            \
	static inline sys_##__nname##_t *sys_##__lname##_get_not_empty(      \
...
#define Z_GENLIST_GET(__lname, __nname)                             \
	static inline sys_##__nname##_t *sys_##__lname##_get(       \
		sys_##__lname##_t *list)                            \
	{                                                           \
		return sys_##__lname##_is_empty(list) ?             \
				     NULL :                               \
...
#define Z_GENLIST_REMOVE(__lname, __nname)                                     \
	static inline void sys_##__lname##_remove(                             \
		sys_##__lname##_t *list, sys_##__nname##_t *prev_node,         \
		sys_##__nname##_t *node)                                       \
	{                                                                      \
		if (prev_node == NULL) {                                       \
			z_##__lname##_head_set(list,                           \
...
#define Z_GENLIST_FIND_AND_REMOVE(__lname, __nname)                       \
	static inline bool sys_##__lname##_find_and_remove(               \
		sys_##__lname##_t *list, sys_##__nname##_t *node)         \
	{                                                                 \
