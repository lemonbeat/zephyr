...
#define REGION_RAM_ATTR(base, size)                                             \
	{                                                                       \
		.rbar = NOT_EXEC | P_RW_U_NA_Msk |                              \
			NON_SHAREABLE_Msk, /* AP, XN, SH */ /* Cache-ability */ \
...
#define K_MEM_PARTITION_P_RW_U_RW                              \
	((k_mem_partition_attr_t){ (P_RW_U_RW_Msk | NOT_EXEC), \
				   MPU_MAIR_INDEX_SRAM })
#define K_MEM_PARTITION_P_RW_U_NA                              \
	((k_mem_partition_attr_t){ (P_RW_U_NA_Msk | NOT_EXEC), \
				   MPU_MAIR_INDEX_SRAM })
#define K_MEM_PARTITION_P_RO_U_RO                              \
	((k_mem_partition_attr_t){ (P_RO_U_RO_Msk | NOT_EXEC), \
				   MPU_MAIR_INDEX_SRAM })
#define K_MEM_PARTITION_P_RO_U_NA                              \
	((k_mem_partition_attr_t){ (P_RO_U_NA_Msk | NOT_EXEC), \
				   MPU_MAIR_INDEX_SRAM })

/* Execution-allowed attributes */
#define K_MEM_PARTITION_P_RWX_U_RWX \
	((k_mem_partition_attr_t){ (P_RW_U_RW_Msk), MPU_MAIR_INDEX_SRAM })
#define K_MEM_PARTITION_P_RX_U_RX \
	((k_mem_partition_attr_t){ (P_RO_U_RO_Msk), MPU_MAIR_INDEX_SRAM })
