...
typedef uint32_t (*_arc_s_call_handler_t)(uint32_t arg1, uint32_t arg2,
...
static inline uint32_t _arc_s_call_invoke6(uint32_t arg1, uint32_t arg2,
					   uint32_t arg3, uint32_t arg4,
					   uint32_t arg5, uint32_t arg6,
					   uint32_t call_id)
{
	...
	__asm__ volatile("sjli %[id]\n"
			 : "=r"(ret)
			 : [id] "i"(SJLI_CALL_ARC_SECURE), "r"(ret), "r"(r1),
			   "r"(r2), "r"(r3), "r"(r4), "r"(r5), "r"(r6));

	return ret;
}

static inline uint32_t _arc_s_call_invoke5(uint32_t arg1, uint32_t arg2,
					   uint32_t arg3, uint32_t arg4,
					   uint32_t arg5, uint32_t call_id)
{
	register uint32_t ret __asm__("r0") = arg1;
	register uint32_t r1 __asm__("r1") = arg2;
	register uint32_t r2 __asm__("r2") = arg3;
...
static inline uint32_t _arc_s_call_invoke4(uint32_t arg1, uint32_t arg2,
					   uint32_t arg3, uint32_t arg4,
					   uint32_t call_id)
{
	register uint32_t ret __asm__("r0") = arg1;
...
static inline uint32_t _arc_s_call_invoke3(uint32_t arg1, uint32_t arg2,
					   uint32_t arg3, uint32_t call_id)
{
	register uint32_t ret __asm__("r0") = arg1;
	register uint32_t r1 __asm__("r1") = arg2;
	register uint32_t r2 __asm__("r2") = arg3;
...
static inline uint32_t _arc_s_call_invoke2(uint32_t arg1, uint32_t arg2,
					   uint32_t call_id)
{
	register uint32_t ret __asm__("r0") = arg1;
	register uint32_t r1 __asm__("r1") = arg2;
...
static inline uint32_t _arc_s_call_invoke1(uint32_t arg1, uint32_t call_id)
{
	...
	__asm__ volatile("sjli %[id]\n"
			 : "=r"(ret)
			 : [id] "i"(SJLI_CALL_ARC_SECURE), "r"(ret), "r"(r6));
