...
struct arc_connect_bcr {
	union {
		struct {
#ifdef CONFIG_BIG_ENDIAN
			uint32_t pad4 : 6, pw_dom : 1, pad3 : 1, idu : 1,
				pad2 : 1, num_cores : 6, pad : 1, gfrc : 1,
				dbg : 1, pw : 1, msg : 1, sem : 1, ipi : 1,
				slv : 1, ver : 8;
#else
			uint32_t ver : 8, slv : 1, ipi : 1, sem : 1, msg : 1,
				pw : 1, dbg : 1, gfrc : 1, pad : 1,
				num_cores : 6, pad2 : 1, idu : 1, pad3 : 1,
				pw_dom : 1, pad4 : 6;
#endif
		};
		uint32_t val;
...
extern void z_arc_connect_idu_set_mode(uint32_t irq_num, uint16_t trigger_mode,
