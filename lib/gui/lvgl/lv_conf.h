...
#define LV_USE_ASSERT_MEM_INTEGRITY \
	IS_ENABLED(CONFIG_LVGL_USE_ASSERT_MEM_INTEGRITY)
...
#define LV_FONT_MONTSERRAT_12_SUBPX \
	IS_ENABLED(CONFIG_LVGL_FONT_MONTSERRAT_12_SUBPX)

#define LV_FONT_MONTSERRAT_28_COMPRESSED \
	IS_ENABLED(CONFIG_LVGL_FONT_MONTSERRAT_28_COMPRESSED)

#define LV_FONT_DEJAVU_16_PERSIAN_HEBREW \
	IS_ENABLED(CONFIG_LVGL_FONT_DEJAVU_16_PERSIAN_HEBREW)
...
#define LV_USE_ARABIC_PERSIAN_CHARS \
	IS_ENABLED(CONFIG_LVGL_USE_ARABIC_PERSIAN_CHARS)
...
#define LV_LABEL_WAIT_CHAR_COUNT CONFIG_LVGL_LABEL_WAIT_CHAR_COUNT
