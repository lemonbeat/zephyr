...
int __printf_like(2, 3)
	sprintf(char *_MLIBC_RESTRICT s, const char *_MLIBC_RESTRICT fmt, ...);
...
int __printf_like(3, 0)
	vsnprintf(char *_MLIBC_RESTRICT s, size_t len,
		  const char *_MLIBC_RESTRICT fmt, va_list list);
int __printf_like(2, 0) vsprintf(char *_MLIBC_RESTRICT s,
				 const char *_MLIBC_RESTRICT fmt, va_list list);
int __printf_like(2, 0)
	vfprintf(FILE *_MLIBC_RESTRICT stream,
		 const char *_MLIBC_RESTRICT format, va_list ap);
